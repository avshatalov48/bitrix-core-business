...
{
	Extension::load([
		'sidepanel', 'landing.metrika', 'ui.buttons', 'ui.dialogs.messagebox', 'ui.layout-form'
	]);
	Extension::load('ui.dialogs.messagebox', 'ui.forms', 'ui.hint');
}
	...
	>
		...
		<?php if (isset($hooks['COPYRIGHT'])): ?>
			...
			<div class="ui-form-row landing-form-additional-row" data-landing-additional-detail="sign">
				...
				<div class="ui-form-content ui-form-content-copyright">
