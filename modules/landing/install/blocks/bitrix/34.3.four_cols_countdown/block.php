<section class="landing-block landing-semantic-background-color g-pt-70 g-pb-70 g-bg-primary">
	<div class="container">
		<div class="row landing-block-inner">
			<div class="landing-block-node-card js-animation fadeInUp col-md-6 col-lg-3 text-center g-mb-40 g-mb-0--lg">
					<span class="landing-block-node-card-icon-container landing-semantic-color-primary g-color-white-opacity-0_6 u-icon-v1 u-icon-size--lg g-mb-15">
