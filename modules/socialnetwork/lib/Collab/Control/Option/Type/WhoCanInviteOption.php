...
class WhoCanInviteOption extends AbstractOption
{
	use UpdateCollabChatTrait;

	public const NAME = 'whoCanInvite';
	public const DB_NAME = 'WHO_CAN_INVITE';
	...
	protected function applyImplementation(Collab $collab): Result
	{
		return $this->updateChat($collab, [
			'MANAGE_USERS_ADD' => static::ROLE_MAP[$this->value]
		]);
	}
}