...
return [
	...
	'items' => [
		...
		1 => [
			...
			'nodes' => [
				...
				'.landing-block-node-title' => [
					0 => Loc::getMessage("LANDING_DEMO_STORE_CHATS_DETAIL-TEXT_1"),
				],
				'.landing-block-node-text' => [
					0 => Loc::getMessage("LANDING_DEMO_STORE_CHATS_DETAIL-TEXT_2"),
				],
			],
			'style' => [
				'#wrapper' => [
		...
		2 => [
			...
			'nodes' => [
				'.landing-block-node-title' => [
					0 => Loc::getMessage('LANDING_DEMO_STORE_CHATS_DETAIL-BACK'),
				],
			],
			'style' => [
				'#wrapper' => [
