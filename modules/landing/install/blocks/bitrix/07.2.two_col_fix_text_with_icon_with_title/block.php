<section class="landing-block g-theme-business-bg-blue-dark-v1 g-pt-20 g-pb-20">
	<div class="container text-center g-width-780 g-color-gray-light-v2 g-mb-20">
		<div class="landing-block-node-header text-uppercase u-heading-v2-4--bottom g-brd-primary g-mb-40">
			<h6 class="landing-block-node-subtitle g-font-weight-700 g-letter-spacing-1 g-color-primary g-mb-20">Work process</h6>
			<h2 class="landing-block-node-title h1 u-heading-v2__title g-line-height-1_3 g-font-weight-700 g-color-white">Step by step</h2>
		</div>
	</div>
	<div class="container">
				...
				<div class="landing-block-card-container g-pos-rel g-parent g-theme-business-bg-blue-dark-v2 g-py-35 g-px-25 g-pl-70--sm g-pl-60 g-ml-30 g-ml-0--sm">
					<div class="g-absolute-centered--y g-left-0 g-absolute-top-px">
						<div class="landing-block-node-element-icon-container g-pull-50x-left g-brd-around g-brd-5 g-rounded-50x g-overflow-hidden g-color-white g-bg-primary">
							<span class="landing-block-node-element-icon-hover d-block g-pos-abs g-top-0 g-left-0 g-width-85 g-height-85 g-rounded-50x opacity-0 g-opacity-1--parent-hover g-pointer-events-none g-transition-0_1 g-transition--ease-in g-bg-size-cover" style="background-image: url(https://cdn.bitrix24.site/bitrix/images/landing/business/100x100/img1.jpg);"></span>
					...
					<h5 class="landing-block-node-element-title text-uppercase g-color-gray-light-v2 g-mb-10">Step 1. Analisys</h5>
