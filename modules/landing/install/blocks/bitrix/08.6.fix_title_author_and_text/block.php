<section class="landing-block g-pt-0 g-pb-40 g-pt-40">
	<div class="landing-block-node-container container">
		<article class="landing-block-card g-brd-bottom js-animation fadeIn g-mb-40 g-mb-0--last">
			<div class="landing-block-bottom-border g-brd-bottom g-brd-1 g-brd-primary g-pb-25 ">
				<h4 class="landing-block-title g-mb-1 g-color-gray-dark-v1">
				...
				<div class="media g-flex-centered">
					...
					<div class="landing-block-author media-body g-color-gray-dark-v3 g-mt-14">
						<p>John Doe</p>
					</div>
				</div>
				<div class="landing-block-text g-mb-15 g-pt-1 g-color-gray-dark-v3">
				...
				<div class="landing-block-bottom g-color-gray-dark-v5">
