...
$MESS["DUMP_BITRIXCLOUD_IS_IN_PROGRESS_CHANGE_ERROR"] = "В данный момент выполняется резервное копирование облачным сервисом. Изменение его параметров невозможно. Дождитесь окончания и повторите попытку редактирования.";
$MESS["DUMP_BITRIXCLOUD_IS_IN_PROGRESS_CHANGE_WARNING"] = "В данный момент выполняется резервное копирование облачным сервисом. Изменение его параметров невозможно.";
?>
