	...
	var Avatar = /*#__PURE__*/function () {
	  ...
	  babelHelpers.createClass(Avatar, null, [{
	    ...
	    value: function build() {
	      ...
	      var avatar = main_core.Tag.render(_templateObject || (_templateObject = babelHelpers.taggedTemplateLiteral(["<span class=\"mail-ui-avatar mail-ui-avatar-", "\">", "</span>"])), config['size'], abbreviation);
