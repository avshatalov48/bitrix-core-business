...
$MESS['SHARING_INFO_POPUP_CONTENT_3_CRM_MSGVER_2'] = 'Отправьте клиенту ссылку на ваши слоты или совместные слоты с коллегами. Клиент сам выберет удобное время для встречи. <a data-role="calendar-sharing-how-does-it-work">Как это работает?</a>';
...
$MESS['CALENDAR_SHARING_SETTINGS_READ_ONLY_HINT_GROUP'] = 'Время для встреч в коллабе нельзя редактировать';
...
$MESS['CALENDAR_SHARING_USER_SELECTOR_TITLE_CRM'] = 'Создать совместные слоты с коллегами';
