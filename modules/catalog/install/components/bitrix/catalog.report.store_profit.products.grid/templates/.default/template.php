...
$title =
	$arParams['STORE_ID'] > 0
		? \Bitrix\Main\Localization\Loc::getMessage('STORE_SALE_REPORT_PRODUCT_GRID_STORE_TITLE',['#STORE_TITLE#' => $arResult['STORE_TITLE']])
		: \Bitrix\Main\Localization\Loc::getMessage('STORE_SALE_REPORT_PRODUCT_GRID_ALL_STORES_TITLE')
;
