...
$MESS['CANCEL_CONDUCT_CANCELLATION_POPUP_TITLE'] = 'Отмена проведения документа';
$MESS['CANCEL_CONDUCT_CANCELLATION_POPUP_QUESTION'] = 'Вы уверены, что хотите отменить проведение этого документа?';
$MESS['CANCEL_CONDUCT_CANCELLATION_POPUP_HINT'] = 'При отмене будут скорректированы только текущие остатки и себестоимость. #HELP_LINK#';
$MESS['CANCEL_CONDUCT_CANCELLATION_POPUP_YES'] = 'Да, отменить';
$MESS['CANCEL_CONDUCT_CANCELLATION_POPUP_NO'] = 'Назад';
$MESS['CANCEL_CONDUCT_CANCELLATION_POPUP_LINK'] = 'Подробнее';