...
(function (exports,landing_node,TableEditor) {
	'use strict';

	TableEditor = TableEditor && TableEditor.hasOwnProperty('default') ? TableEditor['default'] : TableEditor;
	  ...
	  onMousedown(event) {
	    if (!this.manifest.group) {
	      ...
	      if (this.manifest.allowInlineEdit !== false && BX.Landing.Main.getInstance().isControlsEnabled()) {
	        ...
	        if (this.isTable(event)) {
	          this.disableEdit();
	          BX.Landing.Node.Text.currentNode.node.querySelectorAll('.landing-table-container').forEach(table => {
...
}((this.BX.Landing.Node = this.BX.Landing.Node || {}),BX.Landing,BX.Landing.Node.Text.TableEditor));
