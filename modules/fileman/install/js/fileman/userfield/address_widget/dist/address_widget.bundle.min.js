this.BX=this.BX||{};this.BX.Fileman=this.BX.Fileman||{};(function(e,s,a,l,t,i){"use strict";var r=babelHelpers.classPrivateFieldLooseKey("wrapper");class o{constructor(e){Object.defineProperty(this,r,{writable:true,value:null});babelHelpers.classPrivateFieldLooseBase(this,r)[r]=e.wrapper}getWrapper(){return babelHelpers.classPrivateFieldLooseBase(this,r)[r]}layout(){throw new Error("please implement the layout() method")}}let d=e=>e,n,b;var p=babelHelpers.classPrivateFieldLooseKey("addresses");var c=babelHelpers.classPrivateFieldLooseKey("widgets");class v extends o{constructor(e){super(e);Object.defineProperty(this,p,{writable:true,value:[]});Object.defineProperty(this,c,{writable:true,value:[]});babelHelpers.classPrivateFieldLooseBase(this,p)[p]=e.addresses}destroyWidgets(){babelHelpers.classPrivateFieldLooseBase(this,c)[c].forEach((e=>{e.destroy()}))}layout(){const e=t.Tag.render(n||(n=d`<div></div>`));babelHelpers.classPrivateFieldLooseBase(this,p)[p].forEach((s=>{t.Dom.append(this.getLayoutForAddress(s),e)}));t.Dom.append(e,this.getWrapper());return this.getWrapper()}getLayoutForAddress(e){const s=new a.Factory;const i=s.createAddressWidget({address:e,mode:l.ControlMode.view,popupOptions:{offsetLeft:14},popupBindOptions:{forceBindPosition:true,position:"right"},mapBehavior:"auto",useFeatures:{fields:false,map:true,autocomplete:false}});babelHelpers.classPrivateFieldLooseBase(this,c)[c].push(i);const r=t.Tag.render(b||(b=d`
		...
		`),this.getFormattedAddress(e));i.render({mapBindElement:r,controlWrapper:r});return r}getFormattedAddress(e){var s;const a=new l.Format(JSON.parse(BX.message("LOCATION_WIDGET_DEFAULT_FORMAT")));return(s=e.toString(a,l.AddressStringConverter.STRATEGY_TYPE_TEMPLATE_COMMA))!=null?s:""}}let u=e=>e,h,F,P,L,H,B,f,m,y,g,w;var I=babelHelpers.classPrivateFieldLooseKey("widget");var E=babelHelpers.classPrivateFieldLooseKey("nodes");var C=babelHelpers.classPrivateFieldLooseKey("wrapper");var D=babelHelpers.classPrivateFieldLooseKey("address");var A=babelHelpers.classPrivateFieldLooseKey("fieldName");var O=babelHelpers.classPrivateFieldLooseKey("fieldFormName");var T=babelHelpers.classPrivateFieldLooseKey("showMap");var M=babelHelpers.classPrivateFieldLooseKey("enableRemoveButton");var S=babelHelpers.classPrivateFieldLooseKey("isCompactMode");var _=babelHelpers.classPrivateFieldLooseKey("initialAddressId");var j=babelHelpers.classPrivateFieldLooseKey("areDetailsShown");var K=babelHelpers.classPrivateFieldLooseKey("isLoading");var $=babelHelpers.classPrivateFieldLooseKey("isDropdownLoading");var N=babelHelpers.classPrivateFieldLooseKey("isDestroyed");class R extends i.EventEmitter{constructor(e){super();Object.defineProperty(this,I,{writable:true,value:void 0});Object.defineProperty(this,E,{writable:true,value:{}});Object.defineProperty(this,C,{writable:true,value:void 0});Object.defineProperty(this,D,{writable:true,value:null});Object.defineProperty(this,A,{writable:true,value:void 0});Object.defineProperty(this,O,{writable:true,value:void 0});Object.defineProperty(this,T,{writable:true,value:true});Object.defineProperty(this,M,{writable:true,value:false});Object.defineProperty(this,S,{writable:true,value:false});Object.defineProperty(this,_,{writable:true,value:null});Object.defineProperty(this,j,{writable:true,value:false});Object.defineProperty(this,K,{writable:true,value:false});Object.defineProperty(this,$,{writable:true,value:false});Object.defineProperty(this,N,{writable:true,value:false});this.setEventNamespace("Fileman.EditEntry");babelHelpers.classPrivateFieldLooseBase(this,C)[C]=e.wrapper;babelHelpers.classPrivateFieldLooseBase(this,A)[A]=e.fieldName;babelHelpers.classPrivateFieldLooseBase(this,O)[O]=e.fieldFormName;babelHelpers.classPrivateFieldLooseBase(this,M)[M]=e.enableRemoveButton;babelHelpers.classPrivateFieldLooseBase(this,_)[_]=e.initialAddressId;babelHelpers.classPrivateFieldLooseBase(this,T)[T]=e.showMap;if(e.address){babelHelpers.classPrivateFieldLooseBase(this,D)[D]=e.address}if(e.isCompactMode){babelHelpers.classPrivateFieldLooseBase(this,S)[S]=e.isCompactMode}}layout(){const e=new a.Factory;babelHelpers.classPrivateFieldLooseBase(this,I)[I]=e.createAddressWidget({address:babelHelpers.classPrivateFieldLooseBase(this,D)[D],mode:l.ControlMode.edit,popupOptions:{offsetLeft:14},popupBindOptions:{forceBindPosition:true,position:"right"},mapBehavior:"auto",useFeatures:{fields:true,map:babelHelpers.classPrivateFieldLooseBase(this,T)[T],autocomplete:true}});babelHelpers.classPrivateFieldLooseBase(this,E)[E].userInput=t.Tag.render(h||(h=u`<input type="text" class="ui-ctl-element" />`));babelHelpers.classPrivateFieldLooseBase(this,E)[E].fieldsContainer=t.Tag.render(F||(F=u`<div class="location-fields-control-block"></div>`));babelHelpers.classPrivateFieldLooseBase(this,E)[E].detailsToggle=t.Tag.render(P||(P=u`<span class="ui-link ui-link-secondary address-control-mode-switch">${0}</span>`),t.Loc.getMessage("ADDRESS_USERFIELD_DETAILS"));t.Event.bind(babelHelpers.classPrivateFieldLooseBase(this,E)[E].detailsToggle,"click",this.onDetailsToggleClick.bind(this));let s=this.getInitialAddressFieldValue();babelHelpers.classPrivateFieldLooseBase(this,E)[E].fieldValueInput=t.Tag.render(L||(L=u`<input type="hidden" name="${0}" value="${0}" />`),babelHelpers.classPrivateFieldLooseBase(this,O)[O],s);babelHelpers.classPrivateFieldLooseBase(this,E)[E].inputIcon=t.Tag.render(H||(H=u`<button type="button" class="ui-ctl-after ui-ctl-icon-clear"></button>`));t.Event.bind(babelHelpers.classPrivateFieldLooseBase(this,E)[E].inputIcon,"click",this.onInputIconClick.bind(this));babelHelpers.classPrivateFieldLooseBase(this,I)[I].subscribeOnAddressChangedEvent(this.onAddressChanged.bind(this));babelHelpers.classPrivateFieldLooseBase(this,I)[I].subscribeOnStateChangedEvent(this.onWidgetStateChangedEvent.bind(this));babelHelpers.classPrivateFieldLooseBase(this,I)[I].subscribeOnFeatureEvent(this.onFeatureEvent.bind(this));babelHelpers.classPrivateFieldLooseBase(this,E)[E].entryWrapper=t.Tag.render(B||(B=u`
		...
		`),this.getUserInputSizeClass(),babelHelpers.classPrivateFieldLooseBase(this,E)[E].userInput,babelHelpers.classPrivateFieldLooseBase(this,E)[E].fieldsContainer,babelHelpers.classPrivateFieldLooseBase(this,E)[E].inputIcon);const i=babelHelpers.classPrivateFieldLooseBase(this,D)[D]?this.getRawValueForHiddenFormattedInput(babelHelpers.classPrivateFieldLooseBase(this,D)[D]):"";babelHelpers.classPrivateFieldLooseBase(this,E)[E].hiddenFormattedAddressInput=t.Tag.render(f||(f=u`<input type="hidden" name="${0}_formatted" value="${0}" />`),babelHelpers.classPrivateFieldLooseBase(this,A)[A],i);const r=t.Tag.render(m||(m=u`<input type="hidden" name="${0}_manual_edit" value="Y">`),babelHelpers.classPrivateFieldLooseBase(this,A)[A]);babelHelpers.classPrivateFieldLooseBase(this,E)[E].layout=t.Tag.render(y||(y=u`
