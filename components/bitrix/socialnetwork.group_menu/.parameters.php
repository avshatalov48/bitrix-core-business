...
$arComponentParameters = Array(
	...
	"PARAMETERS" => Array(
		...
		"PATH_TO_GROUP_BLOG" => Array(
			"NAME" => GetMessage("SONET_PATH_TO_GROUP_BLOG"),
			"TYPE" => "STRING",
			"MULTIPLE" => "N",
			"DEFAULT" => "",
			"COLS" => 25,
		...
		"PATH_TO_GROUP_FORUM" => Array(
			"NAME" => GetMessage("SONET_PATH_TO_GROUP_FORUM"),
			"TYPE" => "STRING",
			"MULTIPLE" => "N",
			"DEFAULT" => "",
			"COLS" => 25,
		...
		"PATH_TO_GROUP_CALENDAR" => Array(
			"NAME" => GetMessage("SONET_PATH_TO_GROUP_CALENDAR"),
			"TYPE" => "STRING",
			"MULTIPLE" => "N",
			"DEFAULT" => "",
			"COLS" => 25,
		...
		"PATH_TO_GROUP_FILES" => Array(
			"NAME" => GetMessage("SONET_PATH_TO_GROUP_FILES"),
			"TYPE" => "STRING",
			"MULTIPLE" => "N",
			"DEFAULT" => "",
			"COLS" => 25,
