...
(function (exports,ui_designTokens,im_v2_lib_menu,ui_fonts_opensans,im_v2_lib_logger,ui_dexie,im_v2_lib_utils,im_v2_component_elements,main_core,main_core_events,im_v2_const) {
	'use strict';
	...
	const AvatarOpenline = {
	  ...
	  created() {
	    this.isCrmAvailable = main_core.Extension.getSettings('im.v2.component.search').get('isCrmAvailable', false);
	  },
