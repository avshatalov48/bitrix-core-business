this.BX=this.BX||{};(function(e,s){"use strict";let i=e=>e,t,a;const l=Object.freeze({medium:"medium",small:"small",extraSmall:"extra-small"});const r=Object.freeze({primary:"primary",green:"green"});var o=babelHelpers.classPrivateFieldLooseKey("classNameSize");var d=babelHelpers.classPrivateFieldLooseKey("classNameColor");var c=babelHelpers.classPrivateFieldLooseKey("disabled");var n=babelHelpers.classPrivateFieldLooseKey("inputName");var h=babelHelpers.classPrivateFieldLooseKey("loading");var b=babelHelpers.classPrivateFieldLooseKey("classNameOff");var p=babelHelpers.classPrivateFieldLooseKey("classNameLock");var u=babelHelpers.classPrivateFieldLooseKey("attributeName");var v=babelHelpers.classPrivateFieldLooseKey("attributeInitName");var m=babelHelpers.classPrivateFieldLooseKey("initNode");var P=babelHelpers.classPrivateFieldLooseKey("fireEvent");class L{constructor(e){Object.defineProperty(this,P,{value:H});Object.defineProperty(this,m,{value:f});Object.defineProperty(this,o,{writable:true,value:{[l.extraSmall]:"ui-switcher-size-xs",[l.small]:"ui-switcher-size-sm",[l.medium]:""}});Object.defineProperty(this,d,{writable:true,value:{[r.primary]:"",[r.green]:"ui-switcher-color-green"}});this.node=null;this.checked=false;this.id="";Object.defineProperty(this,c,{writable:true,value:false});Object.defineProperty(this,n,{writable:true,value:""});Object.defineProperty(this,h,{writable:true,value:void 0});Object.defineProperty(this,b,{writable:true,value:"ui-switcher-off"});Object.defineProperty(this,p,{writable:true,value:"ui-switcher-lock"});Object.defineProperty(this,u,{writable:true,value:"data-switcher"});this.init(e);L.list.push(this)}static getById(e){return L.list.find((s=>s.id===e))||null}static initByClassName(){const e=document.getElementsByClassName(L.className);Array.from(e).forEach((function(e){if(e.getAttribute(babelHelpers.classPrivateFieldLooseBase(L,v)[v])){return}new L({node:e})}))}static getList(){return L.list}init(e={}){babelHelpers.classPrivateFieldLooseBase(this,u)[u]=s.Type.isString(e.attributeName)?e.attributeName:babelHelpers.classPrivateFieldLooseBase(this,u)[u];this.handlers=s.Type.isPlainObject(e.handlers)?e.handlers:{};babelHelpers.classPrivateFieldLooseBase(this,n)[n]=s.Type.isString(e.inputName)?e.inputName:"";babelHelpers.classPrivateFieldLooseBase(this,h)[h]=false;this.events={toggled:"toggled",checked:"checked",unchecked:"unchecked"};if(e.node){if(!s.Type.isDomNode(e.node)){throw new Error("Parameter `node` DOM Node expected.")}this.node=e.node;let i=this.node.getAttribute(babelHelpers.classPrivateFieldLooseBase(this,u)[u]);try{i=JSON.parse(i)||{}}catch(e){i={}}if(i.id){this.id=i.id}this.checked=Boolean(i.checked);babelHelpers.classPrivateFieldLooseBase(this,n)[n]=i.inputName;if(s.Type.isString(i.color)&&Object.values(r).includes(i.color)){e.color=i.color}if(s.Type.isString(i.size)&&Object.values(l).includes(i.size)){e.size=i.size}}else{this.node=document.createElement("span")}if(babelHelpers.classPrivateFieldLooseBase(this,o)[o][e.size]){s.Dom.addClass(this.node,babelHelpers.classPrivateFieldLooseBase(this,o)[o][e.size])}if(babelHelpers.classPrivateFieldLooseBase(this,d)[d][e.color]){s.Dom.addClass(this.node,babelHelpers.classPrivateFieldLooseBase(this,d)[d][e.color])}if(s.Type.isString(e.id)||s.Type.isNumber(e.id)){this.id=e.id}else if(!this.id){this.id=Math.random()}if(s.Type.isString(e.inputName)){babelHelpers.classPrivateFieldLooseBase(this,n)[n]=e.inputName}this.checked=s.Type.isBoolean(e.checked)?e.checked:this.checked;babelHelpers.classPrivateFieldLooseBase(this,c)[c]=s.Type.isBoolean(e.disabled)?e.disabled:babelHelpers.classPrivateFieldLooseBase(this,c)[c];babelHelpers.classPrivateFieldLooseBase(this,m)[m]();this.check(this.checked,false);this.disable(babelHelpers.classPrivateFieldLooseBase(this,c)[c],false)}disable(e,i){if(this.isLoading()){return}i=i!==false;if(babelHelpers.classPrivateFieldLooseBase(this,c)[c]){s.Dom.addClass(this.node,babelHelpers.classPrivateFieldLooseBase(this,p)[p]);i?babelHelpers.classPrivateFieldLooseBase(this,P)[P](this.events.lock):null}else{s.Dom.removeClass(this.node,babelHelpers.classPrivateFieldLooseBase(this,p)[p]);i?babelHelpers.classPrivateFieldLooseBase(this,P)[P](this.events.unlock):null}if(i){babelHelpers.classPrivateFieldLooseBase(this,P)[P](this.events.toggled)}}check(e,i){if(this.isLoading()){return}this.checked=!!e;if(this.inputNode){this.inputNode.value=this.checked?"Y":"N"}i=i!==false;if(this.checked){s.Dom.removeClass(this.node,babelHelpers.classPrivateFieldLooseBase(this,b)[b]);i?babelHelpers.classPrivateFieldLooseBase(this,P)[P](this.events.unchecked):null}else{s.Dom.addClass(this.node,babelHelpers.classPrivateFieldLooseBase(this,b)[b]);i?babelHelpers.classPrivateFieldLooseBase(this,P)[P](this.events.checked):null}if(i){babelHelpers.classPrivateFieldLooseBase(this,P)[P](this.events.toggled)}}isDisabled(){return babelHelpers.classPrivateFieldLooseBase(this,c)[c]}isChecked(){return this.checked}toggle(){if(this.isDisabled()){return}this.check(!this.isChecked())}setLoading(e){babelHelpers.classPrivateFieldLooseBase(this,h)[h]=Boolean(e);const a=this.getNode().querySelector(".ui-switcher-cursor");if(babelHelpers.classPrivateFieldLooseBase(this,h)[h]){const e=s.Tag.render(t||(t=i`
