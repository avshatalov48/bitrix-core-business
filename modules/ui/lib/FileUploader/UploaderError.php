...
Loc::loadLanguageFile(__DIR__ . '/../../FileUploader/UserErrors.php');
...
class UploaderError extends \Bitrix\Main\Error
{
	...
	public const FILE_ACCESS_DENIED = 'FILE_ACCESS_DENIED';
	public const FILE_APPEND_NOT_FOUND = 'FILE_APPEND_NOT_FOUND';
	public const FILE_COMMIT_FAILED = 'FILE_COMMIT_FAILED';
	...
	public const CONTROLLER_UPLOAD_FAILED = 'CONTROLLER_UPLOAD_FAILED';
	...
	private static array $systemErrors = [
		...
		self::FILE_LOAD_FAILED => 'Could not load a file.',
		self::FILE_FIND_FAILED => 'Could not find a file.',
		self::FILE_MOVE_FAILED => 'Could not move file.',
		self::FILE_ACCESS_DENIED => 'You don\'t have access to this file.',
		self::FILE_APPEND_NOT_FOUND => 'File not found.',
		self::FILE_COMMIT_FAILED => 'Could not commit file.',
		...
		self::CLOUD_EMPTY_BUCKET => 'Could not get the bucket.',
		self::CLOUD_INVALID_CHUNK_SIZE => 'Could not append content. Size of chunk must be more than #minUploadSize#.',
		...
		self::CONTROLLER_UPLOAD_FAILED => 'You cannot use this uploader controller.',
