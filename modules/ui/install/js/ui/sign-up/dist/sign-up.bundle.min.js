this.BX=this.BX||{};(function(t,e,s,i,n,o,a,r){"use strict";let c=t=>t,h,u;class g extends e.EventEmitter{constructor(t){super();this.cache=new n.Cache.MemoryCache;this.setOptions(t);this.setEventNamespace("BX.UI.SignUp.Tabs.Tab");this.subscribeFromOptions(t.events)}setOptions(t){this.cache.set("options",{...t})}getOptions(){return this.cache.get("options",{})}getIconNode(){return this.cache.remember("iconNode",(()=>n.Tag.render(h||(h=c`
			...
			`))));const e=setTimeout((()=>{if(n.Type.isDomNode(t.parentElement)&&!this.cache.has("adjustCanvas")){const e={width:t.parentElement.clientWidth,height:t.parentElement.clientHeight};if(e.width>0&&e.height>0){void this.cache.remember("adjustCanvas",(()=>{const t=this.getLayout();const s=this.getDevicePixelRatio();t.width=e.width*s;t.height=e.height*s;n.Dom.style(t,{width:`${e.width}px`,height:`${e.height}px`});const i=this.getLayout().getContext("2d");const{context2d:o={}}=this.getOptions();if(n.Type.isPlainObject(o)){Object.assign(i,o)}i.scale(s,s)}))}}clearTimeout(e)}));return t}clear(){const t=this.getLayout();const e=t.getContext("2d");e.clearRect(0,0,t.width*2,t.height*2)}renderText(t,e=null){const s=String(t).trim();const i=this.getLayout();const o=i.getContext("2d");o.font="34px Comforter Brush";this.clear();const a=this.getDevicePixelRatio();const r=i.width-20;let c=n.Text.toNumber(o.font);while(c>1&&o.measureText(s).width*a>r){c-=1;o.font=`${c}px Comforter Brush`}const h=o.measureText(s).width*a;if(e!==null&&e!==""){o.fillStyle=e}o.fillText(s,(i.width-h)/(2*a),34)}renderImage(t){return babelHelpers.classPrivateFieldLooseBase(B,L)[L](t).then((t=>{const e=this.getLayout();const s=e.getContext("2d");const i=e.clientWidth/t.width;const n=e.clientHeight/t.height;const o=Math.min(i,n);const a=(e.clientWidth-t.width*o)/2;const r=(e.clientHeight-t.height*o)/2;this.clear();s.drawImage(t,0,0,t.width,t.height,a,r,t.width*o,t.height*o)}))}}function _(t){const e=new FileReader;return new Promise((s=>{e.readAsDataURL(t);n.Event.bindOnce(e,"loadend",(()=>{const t=new Image;t.src=e.result;n.Event.bindOnce(t,"load",(()=>{s(t)}))}))}))}Object.defineProperty(B,L,{value:_});class f extends e.EventEmitter{constructor(t={}){super();this.cache=new n.Cache.MemoryCache;this.setEventNamespace("BX.UI.SignUp.Content");this.subscribeFromOptions(t.events);this.setOptions(t)}getColor(){var t;return(t=this.getOptions().color)!=null?t:null}setOptions(t){this.cache.set("options",{...t})}getOptions(){return this.cache.get("options",{})}getLayout(){throw new Error("Must be implemented in a child class")}getCanvas(){throw new Error("Must be implemented in a child class")}}let w=t=>t,E,O,U;class x extends f{constructor(t){super(t);this.setEventNamespace("BX.UI.SignUp.Content.InitialsContent");this.subscribeFromOptions(t==null?void 0:t.events);this.onInput=this.onInput.bind(this);void this.forceLoadFonts()}forceLoadFonts(){const t=[...document.fonts];const e=t.filter((t=>String(t.family).includes("Comforter Brush")));return Promise.all(e.map((t=>t.load())))}getNameInput(){return this.cache.remember("nameInput",(()=>n.Tag.render(E||(E=w`
				<input type="text" class="ui-ctl-element" oninput="${0}">
			`),this.onInput)))}getInitialsInput(){return this.cache.remember("initialsInput",(()=>n.Tag.render(O||(O=w`
				<input type="text" class="ui-ctl-element" oninput="${0}">
			`),this.onInput)))}getTextValue(){const t=String(this.getNameInput().value);const e=String(this.getInitialsInput().value);return`${t} ${e}`}onInput(){this.getCanvas().renderText(this.getTextValue(),this.getColor());this.emit("onChange")}getCanvas(){return this.cache.remember("canvas",(()=>new B({context2d:{fillStyle:"#000000",font:"34px Comforter Brush"}})))}getLayout(){return this.cache.remember("layout",(()=>n.Tag.render(U||(U=w`
			...
			`),t,(()=>{if(this.getOptions().mode==="mobile"){return n.Loc.getMessage("UI_SIGN_UP_TOUCH_LAYOUT_MOBILE_LABEL")}return n.Loc.getMessage("UI_SIGN_UP_TOUCH_LAYOUT_LABEL")})(),this.getClearButton(),this.getCanvas().getLayout())}))}}k.LineWidth=3;let $=t=>t,A,H,F,R,X;class G extends f{constructor(t){super(t);this.setEventNamespace("BX.UI.SignUp.Content.PhotoContent");this.subscribeFromOptions(t==null?void 0:t.events)}getTakePhotoButton(){return this.cache.remember("takePhotoButton",(()=>new o.Button({text:n.Loc.getMessage("UI_SIGN_UP_TAKE_SIGN_PHOTO"),color:o.ButtonColor.LIGHT_BORDER,round:true,noCaps:true,className:"ui-sign-up-special-mobile-btn"})))}getUploadPhoto(){return this.cache.remember("uploadPhoto",(()=>new o.Button({text:n.Loc.getMessage("UI_SIGN_UP_UPLOAD_SIGN_PHOTO"),color:o.ButtonColor.LIGHT_BORDER,round:true,noCaps:true,className:"ui-sign-up-special-mobile-btn",onclick:this.onUploadPhotoClick.bind(this)})))}getFileInput(){return this.cache.remember("fileInput",(()=>n.Tag.render(A||(A=$`
