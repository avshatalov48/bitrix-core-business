...
$MESS ['AFF_REG_PAGE_TIP'] = "This path will be added to the affiliate's instruction. A user who wants to become an affiliate can click the link created with this path. The default value is /affiliate/register.php";
$MESS ['SET_TITLE_TIP'] = "If checked, the page title will be set to \"New Affiliate Registration\".";
?>
