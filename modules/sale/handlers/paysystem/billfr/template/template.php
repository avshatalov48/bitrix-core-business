...
<table class="header">
	<tr>
		...
		<td>
			...
			<b><?=sprintf(Loc::getMessage('SALE_HPS_BILLFR_COMPANY_PHONE').": %s", htmlspecialcharsbx($params["SELLER_COMPANY_PHONE"])); ?></b><br>
			<? } ?>
		</td>
	</tr>
</table>
	...
	<tr>
		...
		<td align="right">
			<?if ($params['BILLFR_PAYER_SHOW'] === 'Y'):?>
				<table class="inv">
					<tr align="right">
						<td><b><?=htmlspecialcharsbx($params['BILLFR_HEADER']);?> <?= Loc::getMessage('SALE_HPS_BILLFR_NUMBER') ?>:&nbsp;</b></td>
	...
	<tr>
		...
		<? if ($bankAccNo && $bankRouteNo && $bankSwift) { ?>
			...
			<? if ($params["SELLER_COMPANY_NAME"]) { ?>
				<?=Loc::getMessage('SALE_HPS_BILLFR_COMPANY_NAME')?>: <?=htmlspecialcharsbx($params["SELLER_COMPANY_NAME"]); ?>
				<br>
			<? } ?>

			<?=Loc::getMessage('SALE_HPS_BILLFR_COMPANY_BANK')?> <?= Loc::getMessage('SALE_HPS_BILLFR_NUMBER') ?>: <?=htmlspecialcharsbx($bankAccNo); ?>
			<br>
			...
			<? if ($bank || $bankAddr || $bankPhone) { ?>
				<?=Loc::getMessage('SALE_HPS_BILLFR_COMPANY_BANK_2')?>: <? if ($bank) { ?><?=htmlspecialcharsbx($bank); ?><? } ?>
				<br>
			...
			<?=Loc::getMessage('SALE_HPS_BILLFR_COMPANY_BANK_ROUTE_NO')?>: <?=htmlspecialcharsbx($bankRouteNo); ?>
			<br>

			<?=Loc::getMessage('SALE_HPS_BILLFR_COMPANY_BANK_SWIFT')?>: <?=htmlspecialcharsbx($bankSwift); ?>
			<br>
		<? } ?>
