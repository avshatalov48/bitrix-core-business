...
//			dbg: del?
//			'.landing-block-node-card-price-list li:nth-child(odd)' =>
//				array(
//					'name' => Loc::getMessage('LANDING_BLOCK_11.2.THREE_COLS_FIX_TARIFFS_BLACK_NODES_LANDINGBLOCKNODECARDPRICELIST_ODD'),
//					'type' => array('background-color', 'background-gradient', 'typo'),
//				),
//			'.landing-block-node-card-price-list li:nth-child(even)' =>
//				array(
//					'name' => Loc::getMessage('LANDING_BLOCK_11.2.THREE_COLS_FIX_TARIFFS_BLACK_NODES_LANDINGBLOCKNODECARDPRICELIST_EVEN'),
//					'type' => array('background-color', 'background-gradient', 'typo'),
//				),
			'.landing-block-node-card-button' =>
				array(
