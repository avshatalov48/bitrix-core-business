			...
			<div class="landing-block-node-img d-flex align-items-center col-md-6 col-lg-6 u-bg-overlay g-bg-img-hero g-bg-black-opacity-0_7--after g-min-height-75vh"
				...
				<div class="landing-block-node-inner-container w-100 g-flex-centered g-pr-50--md text-md-right">
					<div class="landing-block-node-inner-container-left js-animation fadeInLeft w-100 u-bg-overlay__inner g-pt-100 g-pb-100">
						<h3 class="landing-block-node-small-title landing-block-node-small-title-left landing-semantic-subtitle-medium-primary h4 font-weight-bold g-color-primary g-mb-20">
						...
						<div class="landing-block-node-title-container g-brd-primary g-mb-30">
							<div class="landing-block-node-border-container g-brd-inherit g-brd-left g-brd-left-none--md g-brd-right--md g-brd-7 g-pl-30 g-pr-30 g-pl-0--lg">
								<h2 class="landing-block-node-title landing-block-node-title-left landing-semantic-title-image-medium g-color-white text-uppercase g-line-height-0_9 font-weight-bold g-font-size-76 mb-0">
									Interior<br>works
								</h2>
							</div>
						</div>
						<div class="landing-block-node-button-container">
							<a class="landing-block-node-button landing-semantic-link-medium-white btn btn-lg u-btn-inset mx-2" href="#">Read more</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="landing-block-node-img d-flex align-items-center col-md-6 col-lg-6 u-bg-overlay g-bg-img-hero g-bg-black-opacity-0_7--after g-min-height-75vh"
				...
				<div class="landing-block-node-inner-container w-100 g-flex-centered g-pl-50--md">
					<div class="landing-block-node-inner-container-right js-animation fadeInRight w-100 u-bg-overlay__inner g-pt-100 g-pb-100">
						<h3 class="landing-block-node-small-title landing-block-node-small-title-right landing-semantic-subtitle-medium-primary h4 font-weight-bold g-color-primary g-mb-20">
							We professionally do</h3>

						<div class="landing-block-node-title-container g-brd-primary g-mb-30">
							<div class="landing-block-node-border-container g-brd-inherit g-brd-left g-brd-7 g-pl-30">
								<h2 class="landing-block-node-title landing-block-node-title-right landing-semantic-title-image-medium g-color-white text-uppercase g-line-height-0_9 font-weight-bold g-font-size-76 mb-0">
									Exterior<br>works
								</h2>
							</div>
						</div>
