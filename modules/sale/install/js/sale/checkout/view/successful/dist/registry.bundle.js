...
(function (exports,main_core,sale_checkout_lib,currency_currencyCore,ui_vue) {
	...
	ui_vue.Vue.component('sale-checkout-view-successful-property_list', {
	  props: ['items', 'order'],
	  computed: {
	    localize: function localize() {
	      return Object.freeze(ui_vue.Vue.getFilteredPhrases('CHECKOUT_VIEW_SUCCESSFUL_'));
	    },
	...
	ui_vue.Vue.component('sale-checkout-view-successful-call', {
	  computed: {
	    localize: function localize() {
	      return Object.freeze(ui_vue.Vue.getFilteredPhrases('CHECKOUT_VIEW_SUCCESSFUL_CALL_'));
	    }
	  },
	  // language=Vue
	...
	ui_vue.Vue.component('sale-checkout-view-successful-without-ps', {
	...
	ui_vue.Vue.component('sale-checkout-view-successful_ps_return', {
	...
	ui_vue.Vue.component('sale-checkout-view-successful', {
	  props: ['items', 'order', 'config'],
	  computed: {
	    localize: function localize() {
	      return Object.freeze(ui_vue.Vue.getFilteredPhrases('CHECKOUT_VIEW_SUCCESSFUL_'));
