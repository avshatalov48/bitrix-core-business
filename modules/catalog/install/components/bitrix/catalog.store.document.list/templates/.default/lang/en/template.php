...
$MESS["BATCH_METHOD_POPUP_TEXT_1"] = "You didn't select the costing method. Profit values will not be calculated.";
$MESS["BATCH_METHOD_POPUP_TEXT_2"] = "There are two costing methodologies: FIFO where the item acquired first is sold first; and average cost price. Select the costing method that fits your business model to see profit and margin values in the reports. [link]Learn more[/link]";
