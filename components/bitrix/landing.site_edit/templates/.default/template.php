					...
					<td class="ui-form-right-cell">
						<div class="landing-domain">
							<?php if (Manager::isB24()):
								...
								<?php if (!\Bitrix\Landing\Domain::getBitrix24Subdomain($domain['DOMAIN'])):?>
									<?php if (\Bitrix\Landing\Domain\Register::isDomainActive($domain['DOMAIN'])):?>
						...
						<div class="landing-form-wrapper">
							<?php if (isset($pageFields['THEME_COLOR'])):
								...
								?>
									...
									<div id="set-colors" class="landing-template-preview-palette landing-template-preview-themes" data-name="theme">
										<?php
								...
								<div class="landing-form-type-page-wrap">
									...
									<span class="landing-form-type-page landing-form-type-<?= $key?>">
										<input type="radio" <?
											...
											?>class="ui-radio" <?
											?>id="view-type-<?= $key?>" <?
											?><?php if ($value == $key){?> checked="checked"<?}?> <?
											?>value="<?= $key;?>" />
									...
									<?php if (isset($pageFields['COOKIES_USE'])):?>
										...
										<div class="landing-form-cookies-inner">
											<?php if (isset($pageFields['COOKIES_MODE'])):
												...
												{
													$selectedValue = \Bitrix\Landing\Hook\Page\Cookies::MODE_I;
												}
												?>
												...
												<?php foreach ($modeOptions as $modeKey => $modeTitle):
													...
													<div class="landing-cookies-work-modes-item">
														<input type="radio" name="fields[ADDITIONAL_FIELDS][COOKIES_MODE]" <?
															?><?= ($selectedValue == $modeKey) ? ' checked="checked"' : '';?> <?
															?>value="<?= $modeKey;?>" <?
