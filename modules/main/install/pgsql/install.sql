...
CREATE INDEX ix_b_cache_tag_site_id_cache_salt_relative_path ON b_cache_tag (site_id, cache_salt, relative_path);
CREATE INDEX ix_b_cache_tag_tag ON b_cache_tag (tag);
...
CREATE INDEX ix_b_user_access_user_id_access_code ON b_user_access (user_id, access_code);
