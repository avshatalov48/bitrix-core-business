...
$diskFilter = new FolderListFilter((int) $arResult['storageId'], false);
...
<div class="sn-spaces__toolbar-space_basic">
	<div class="sn-spaces__toolbar-space_left-content">
		<div id="sn-spaces-toolbar-files-add-btn"></div>
		<div
...
<script>
	BX.ready(function() {
		...
		const filesToolbar = new BX.Socialnetwork.Spaces.FilesToolbar({
			...
			pathToFilesBizprocWorkflowAdmin: '<?= CUtil::JSescape($arResult['pathToFilesBizprocWorkflowAdmin']) ?>',
		...
		filesToolbar.renderAddBtnTo(document.getElementById('sn-spaces-toolbar-files-add-btn'));
