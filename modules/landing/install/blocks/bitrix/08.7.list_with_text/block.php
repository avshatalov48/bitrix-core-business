	...
	<div class="landing-block-container container">
		<div class="landing-block-card row js-animation fadeIn g-mb-10 g-mb-0--last">
			<div class="row col-12 align-items-center">
				...
				<h2 class="landing-block-title landing-semantic-title-small col-10 col-md-11 text-left g-font-size-22 g-font-weight-700 g-ma-0">
					Change in ID for renting a room
				</h2>
			</div>
			<div class="row col-12 align-items-center">
				<div class="landing-block-text landing-semantic-text-medium col-10 offset-2 col-md-11 offset-md-1 text-left g-font-size-16">
