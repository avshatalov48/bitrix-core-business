...
return array(
	...
	'items' => array(
		'0' => array(
			...
			'nodes' => array(
				'.landing-block-node-title' => array(
					0 => Loc::getMessage('LANDING_DEMO_STORE_CHATS_LIGHT-ORDER-TEXT5'),
				),
			),
			'style' => array(
				'#wrapper' => array(
				...
				'.landing-block-node-title' => array(
					0 => 'landing-block-node-title h2 g-color-gray-dark-v1 text-left g-font-size-27 container g-pl-0 g-pr-0',
				),
			),
		),
		'1' => array(
		...
		'2' => array(
			...
			'nodes' => array(
				'.landing-block-node-title' => array(
					0 => Loc::getMessage('LANDING_DEMO_STORE_CHATS_LIGHT-ORDER-TEXT4'),
				),
				...
				'.landing-block-node-button' => array(
					0 => array(
						'href' => 'tel:+469548521',
						'text' => Loc::getMessage('LANDING_DEMO_STORE_CHATS_LIGHT-ORDER-TEXT3'),
					),
				),
			),
			'style' => array(
		...
		'3' => array(
			...
			'nodes' => array(
				'.landing-block-node-title' => array(
					0 => Loc::getMessage('LANDING_DEMO_STORE_CHATS_LIGHT-ORDER-TEXT1'),
				),
				'.landing-block-node-text' => array(
					0 => Loc::getMessage('LANDING_DEMO_STORE_CHATS_LIGHT-ORDER-TEXT2'),
				),
			),
			'style' => array(
				'.landing-block-node-title' => array(
