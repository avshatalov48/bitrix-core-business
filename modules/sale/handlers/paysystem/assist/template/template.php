...
<form action="<?=$params['URL'];?>" METHOD="POST" target="_blank" class="mb-5">
	...
	<input TYPE="SUBMIT" name="Submit" class="btn btn-primary" value="<?=Loc::getMessage("SALE_HANDLERS_PAY_SYSTEM_ASSIST_ACTION");?>">
</form>
