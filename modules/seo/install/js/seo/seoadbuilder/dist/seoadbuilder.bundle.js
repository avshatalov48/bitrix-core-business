this.BX = this.BX || {};
(function (exports,main_popup,ui_buttons,seo_ads_login,catalog_productSelector,main_core_events,main_core,ui_entitySelector) {
	'use strict';
	  ...
	  babelHelpers.createClass(SeoPostSelector, [{
	    ...
	    value: function successFn(response) {
	      ...
	      data.postList.forEach(function (postListItem) {
	        var postBlock = main_core.Tag.render(_templateObject$2(), postListItem.id, postListItem.media_url, postListItem.caption || '', postListItem.id, postListItem.id, main_core.Loc.getMessage('SEO_AD_BUILDER_POST_SELECTOR_SELECT'));
...
}((this.BX.Seo = this.BX.Seo || {}),BX.Main,BX.UI,BX.Seo.Ads,BX.Catalog,BX.Event,BX,BX.UI.EntitySelector));
