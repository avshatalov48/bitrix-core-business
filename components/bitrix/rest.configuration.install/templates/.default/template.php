...
{
	$messageList['REST_CONFIGURATION_IMPORT_INSTALL_FINISH_TEXT'] = $arResult['MANIFEST']['IMPORT_INSTALL_FINISH_TEXT'];
}
if (isset($arResult['MANIFEST']['IMPORT_FINISH_DESCRIPTION']))
{
	$messageList['REST_CONFIGURATION_IMPORT_FINISH_DESCRIPTION'] = $arResult['MANIFEST']['IMPORT_FINISH_DESCRIPTION'];
}
?>
