...
(function (exports) {
  ...
  function arrayify(values) {
    return babelHelpers["typeof"](values) !== "object" || "length" in values ? values : Array.from(values);
  }
  function reducer(reduce) {
    return function (values) {
      return reduce.apply(void 0, babelHelpers.toConsumableArray(values));
    };
  }
  function cross() {
  ...
  function variance(values, valueof) {
    ...
    if (valueof === undefined) {
      ...
      var index = -1;
      var _iterator2 = _createForOfIteratorHelper$2(values),
        _step2;
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          var _value = _step2.value;
  ...
  var Adder = /*#__PURE__*/function () {
    function Adder() {
      babelHelpers.classCallCheck(this, Adder);
      this._partials = new Float64Array(32);
      this._n = 0;
    }
    babelHelpers.createClass(Adder, [{
      key: "add",
  ...
  function fsum(values, valueof) {
    ...
    if (valueof === undefined) {
      ...
      var index = -1;
      var _iterator2 = _createForOfIteratorHelper$4(values),
        _step2;
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          var _value = _step2.value;
  ...
  var InternMap = /*#__PURE__*/function (_Map) {
    babelHelpers.inherits(InternMap, _Map);
    function InternMap(entries) {
      var _this;
      var key = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : keyof;
      babelHelpers.classCallCheck(this, InternMap);
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(InternMap).call(this));
    ...
    babelHelpers.createClass(InternMap, [{
      key: "get",
      value: function get(key) {
        return babelHelpers.get(babelHelpers.getPrototypeOf(InternMap.prototype), "get", this).call(this, intern_get(this, key));
      }
    }, {
      key: "has",
      value: function has(key) {
        return babelHelpers.get(babelHelpers.getPrototypeOf(InternMap.prototype), "has", this).call(this, intern_get(this, key));
      }
    }, {
      key: "set",
      value: function set(key, value) {
        return babelHelpers.get(babelHelpers.getPrototypeOf(InternMap.prototype), "set", this).call(this, intern_set(this, key), value);
      }
    }, {
      key: "delete",
      value: function _delete(key) {
        return babelHelpers.get(babelHelpers.getPrototypeOf(InternMap.prototype), "delete", this).call(this, intern_delete(this, key));
      }
    }]);
    return InternMap;
  }( /*#__PURE__*/babelHelpers.wrapNativeSuper(Map));
  var InternSet = /*#__PURE__*/function (_Set) {
    babelHelpers.inherits(InternSet, _Set);
    function InternSet(values) {
      var _this2;
      var key = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : keyof;
      babelHelpers.classCallCheck(this, InternSet);
      _this2 = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(InternSet).call(this));
      Object.defineProperties(babelHelpers.assertThisInitialized(_this2), {
        _intern: {
          value: new Map()
        },
        _key: {
      ...
      if (values != null) {
        var _iterator2 = _createForOfIteratorHelper$5(values),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
    ...
    babelHelpers.createClass(InternSet, [{
      key: "has",
      value: function has(value) {
        return babelHelpers.get(babelHelpers.getPrototypeOf(InternSet.prototype), "has", this).call(this, intern_get(this, value));
      }
    }, {
      key: "add",
      value: function add(value) {
        return babelHelpers.get(babelHelpers.getPrototypeOf(InternSet.prototype), "add", this).call(this, intern_set(this, value));
      }
    }, {
      key: "delete",
      value: function _delete(value) {
        return babelHelpers.get(babelHelpers.getPrototypeOf(InternSet.prototype), "delete", this).call(this, intern_delete(this, value));
      }
    }]);
    return InternSet;
  }( /*#__PURE__*/babelHelpers.wrapNativeSuper(Set));
  ...
  function keyof(value) {
    return value !== null && babelHelpers["typeof"](value) === "object" ? value.valueOf() : value;
  }
      ...
      groups = groups.flatMap(function (g) {
        return g.pop().map(function (_ref) {
          var _ref2 = babelHelpers.slicedToArray(_ref, 2),
            key = _ref2[0],
            value = _ref2[1];
          return [].concat(babelHelpers.toConsumableArray(g), [key, value]);
        });
      });
    }
    return groups;
  ...
  function nest(values, map, reduce, keys) {
    return function regroup(values, i) {
      ...
      var keyof = keys[i++];
      var index = -1;
      var _iterator = _createForOfIteratorHelper$6(values),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var value = _step.value;
      ...
      var _iterator2 = _createForOfIteratorHelper$6(groups),
        _step2;
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
  ...
  function sort(values) {
    ...
    var _F = F,
      _F2 = babelHelpers.slicedToArray(_F, 1),
      f = _F2[0];
    if (f && f.length !== 2 || F.length > 1) {
      ...
      if (F.length > 1) {
        ...
        index.sort(function (i, j) {
          var _iterator = _createForOfIteratorHelper$7(F),
            _step;
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done;) {
              var _f = _step.value;
  ...
  function groupSort(values, reduce, key) {
    return (reduce.length !== 2 ? sort(rollup(values, reduce, key), function (_ref, _ref2) {
      var _ref3 = babelHelpers.slicedToArray(_ref, 2),
        ak = _ref3[0],
        av = _ref3[1];
      var _ref4 = babelHelpers.slicedToArray(_ref2, 2),
        bk = _ref4[0],
        bv = _ref4[1];
      return ascending(av, bv) || ascending(ak, bk);
    }) : sort(group(values, key), function (_ref5, _ref6) {
      var _ref7 = babelHelpers.slicedToArray(_ref5, 2),
        ak = _ref7[0],
        av = _ref7[1];
      var _ref8 = babelHelpers.slicedToArray(_ref6, 2),
        bk = _ref8[0],
        bv = _ref8[1];
    ...
    function histogram(data) {
      ...
      if (!Array.isArray(tz)) {
        ...
        if (domain === extent) {
          ...
          var _nice2 = babelHelpers.slicedToArray(_nice, 2);
          x0 = _nice2[0];
          x1 = _nice2[1];
        }
        tz = ticks(x0, x1, tn);
  ...
  function max(values, valueof) {
    var max;
    if (valueof === undefined) {
      var _iterator = _createForOfIteratorHelper$8(values),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var value = _step.value;
      ...
      var index = -1;
      var _iterator2 = _createForOfIteratorHelper$8(values),
        _step2;
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          var _value = _step2.value;
  ...
  function maxIndex(values, valueof) {
    ...
    var index = -1;
    if (valueof === undefined) {
      var _iterator = _createForOfIteratorHelper$9(values),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var value = _step.value;
      ...
      var _iterator2 = _createForOfIteratorHelper$9(values),
        _step2;
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          var _value = _step2.value;
  ...
  function minIndex(values, valueof) {
    ...
    var index = -1;
    if (valueof === undefined) {
      var _iterator = _createForOfIteratorHelper$b(values),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var value = _step.value;
      ...
      var _iterator2 = _createForOfIteratorHelper$b(values),
        _step2;
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          var _value = _step2.value;
  ...
  function greatest(values) {
    ...
    if (compare.length === 1) {
      var maxValue;
      var _iterator = _createForOfIteratorHelper$c(values),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      var _iterator2 = _createForOfIteratorHelper$c(values),
        _step2;
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          var _value = _step2.value;
  ...
  function quantileIndex(values, p) {
    var valueof = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : number;
    if (isNaN(p = +p)) return;
    numbers$$1 = Float64Array.from(values, function (_, i) {
    ...
    var numbers$$1,
      ...
      j = numbers$$1.length - 1,
      i = Math.floor(j * p);
    quickselect(index, i, 0, j, function (i, j) {
      return ascendingDefined(numbers$$1[i], numbers$$1[j]);
    });
  ...
  function mean(values, valueof) {
    ...
    var sum = 0;
    if (valueof === undefined) {
      var _iterator = _createForOfIteratorHelper$d(values),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var value = _step.value;
      ...
      var index = -1;
      var _iterator2 = _createForOfIteratorHelper$d(values),
        _step2;
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          var _value = _step2.value;
  ...
  var _marked$1 = /*#__PURE__*/_regeneratorRuntime$1().mark(flatten$1);
  ...
  function flatten$1(arrays) {
    ...
    return _regeneratorRuntime$1().wrap(function flatten$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _iterator = _createForOfIteratorHelper$e(arrays);
          _context.prev = 1;
          _iterator.s();
        case 3:
          if ((_step = _iterator.n()).done) {
  ...
  function mode(values, valueof) {
    ...
    if (valueof === undefined) {
      var _iterator = _createForOfIteratorHelper$f(values),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var value = _step.value;
      ...
      var index = -1;
      var _iterator2 = _createForOfIteratorHelper$f(values),
        _step2;
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          var _value = _step2.value;
    ...
    var modeValue;
    var modeCount = 0;
    var _iterator3 = _createForOfIteratorHelper$f(counts),
      _step3;
    try {
  ...
  function pairs(values) {
    ...
    var previous;
    var first = false;
    var _iterator = _createForOfIteratorHelper$g(values),
      _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var value = _step.value;
  ...
  function least(values) {
    ...
    if (compare.length === 1) {
      var minValue;
      var _iterator = _createForOfIteratorHelper$h(values),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var element = _step.value;
      ...
      var _iterator2 = _createForOfIteratorHelper$h(values),
        _step2;
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          var _value = _step2.value;
  ...
  function greatestIndex(values) {
    ...
    var max = -1;
    var index = -1;
    var _iterator = _createForOfIteratorHelper$j(values),
      _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var value = _step.value;
  ...
  function sum(values, valueof) {
    var sum = 0;
    if (valueof === undefined) {
      var _iterator = _createForOfIteratorHelper$k(values),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var value = _step.value;
      ...
      var index = -1;
      var _iterator2 = _createForOfIteratorHelper$k(values),
        _step2;
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          var _value = _step2.value;
  ...
  function every(values, test) {
    ...
    var index = -1;
    var _iterator = _createForOfIteratorHelper$l(values),
      _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var value = _step.value;
  ...
  function some(values, test) {
    if (typeof test !== "function") throw new TypeError("test is not a function");
    var index = -1;
    var _iterator = _createForOfIteratorHelper$m(values),
      _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var value = _step.value;
  ...
  function _createForOfIteratorHelper$n(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray$n(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }
  ...
  function _createForOfIteratorHelper$o(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray$o(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }
  ...
  function difference(values) {
    ...
    for (var _i = 0, _others = others; _i < _others.length; _i++) {
      ...
      var _iterator = _createForOfIteratorHelper$o(other),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var value = _step.value;
  ...
  function _createForOfIteratorHelper$p(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray$p(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }
  ...
  function disjoint(values, other) {
    var iterator = other[Symbol.iterator](),
      set = new InternSet();
    var _iterator = _createForOfIteratorHelper$p(values),
      _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var v = _step.value;
  ...
  function _createForOfIteratorHelper$q(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray$q(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }
  ...
  function intersection(values) {
    ...
    var _iterator = _createForOfIteratorHelper$q(values),
      _step;
    try {
      out: for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var value = _step.value;
        var _iterator2 = _createForOfIteratorHelper$q(others),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
  ...
  function _createForOfIteratorHelper$r(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray$r(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }
  ...
  function superset(values, other) {
    var iterator = values[Symbol.iterator](),
      set = new Set();
    var _iterator = _createForOfIteratorHelper$r(other),
      _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var o = _step.value;
  ...
  function _createForOfIteratorHelper$s(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray$s(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }
  ...
  function union() {
    ...
    for (var _i = 0, _others = others; _i < _others.length; _i++) {
      var other = _others[_i];
      var _iterator = _createForOfIteratorHelper$s(other),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var o = _step.value;
  ...
  function _createForOfIteratorHelper$t(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray$t(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }
  ...
  function selection_size () {
    var size = 0;
    var _iterator = _createForOfIteratorHelper$t(this),
      _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
  ...
  var _marked$2 = /*#__PURE__*/_regeneratorRuntime$2().mark(_callee);
  function _callee() {
  ...
  Selection.prototype = selection.prototype = babelHelpers.defineProperty({
  ...
  function dragDisable (view) {
    var root = view.document.documentElement,
      selection$$1 = select(view).on("dragstart.drag", noevent, nonpassivecapture);
    if ("onselectstart" in root) {
      selection$$1.on("selectstart.drag", noevent, nonpassivecapture);
    } else {
  ...
  function piecewise(interpolate, values) {
    if (values === undefined) values = interpolate, interpolate = interpolateValue;
    var i = 0,
      n = values.length - 1,
      v = values[0],
      I = new Array(n < 0 ? 0 : n);
  ...
  Transition.prototype = transition.prototype = babelHelpers.defineProperty({
  ...
  function _createForOfIteratorHelper$u(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray$u(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }
  ...
  function brush$1(dim) {
    ...
    brush.move = function (group, selection$$1, event) {
      if (group.tween) {
    ...
    function started(event) {
      ...
      if (type === "overlay") {
        ...
        state.selection = selection$$1 = [[w0 = dim === Y ? W : min$1(pts[0][0], pts[1][0]), n0 = dim === X ? N : min$1(pts[0][1], pts[1][1])], [e0 = dim === Y ? E : max$1(pts[0][0], pts[1][0]), s0 = dim === X ? S : max$1(pts[0][1], pts[1][1])]];
      ...
      function moved(event) {
        var _iterator = _createForOfIteratorHelper$u(event.changedTouches || [event]),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var p = _step.value;
            var _iterator3 = _createForOfIteratorHelper$u(points),
              _step3;
            try {
              for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
                var d = _step3.value;
        ...
        var _iterator2 = _createForOfIteratorHelper$u(points),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
  ...
  function _createForOfIteratorHelper$v(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray$v(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }
  ...
  function chord$1(directed, transpose) {
    ...
    function chord(matrix) {
      ...
      // Compute the angles for each group and constituent chord.
      {
        ...
        var _iterator = _createForOfIteratorHelper$v(groupIndex),
          _step;
        try {
          var _loop = function _loop() {
            ...
            if (directed) {
              ...
              var _iterator2 = _createForOfIteratorHelper$v(subgroupIndex),
                _step2;
              try {
                for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
                  var _j = _step2.value;
              ...
              var _iterator3 = _createForOfIteratorHelper$v(_subgroupIndex),
                _step3;
              try {
                for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
  ...
  var Path = /*#__PURE__*/function () {
    ...
    babelHelpers.createClass(Path, [{
      ...
      value: function moveTo(x, y) {
        this._append(_templateObject || (_templateObject = babelHelpers.taggedTemplateLiteral(["M", ",", ""])), this._x0 = this._x1 = +x, this._y0 = this._y1 = +y);
      }
    }, {
      key: "closePath",
      value: function closePath() {
        if (this._x1 !== null) {
          ...
          this._append(_templateObject2 || (_templateObject2 = babelHelpers.taggedTemplateLiteral(["Z"])));
        }
      }
    }, {
      key: "lineTo",
      value: function lineTo(x, y) {
        this._append(_templateObject3 || (_templateObject3 = babelHelpers.taggedTemplateLiteral(["L", ",", ""])), this._x1 = +x, this._y1 = +y);
      }
    }, {
      key: "quadraticCurveTo",
      value: function quadraticCurveTo(x1, y1, x, y) {
        this._append(_templateObject4 || (_templateObject4 = babelHelpers.taggedTemplateLiteral(["Q", ",", ",", ",", ""])), +x1, +y1, this._x1 = +x, this._y1 = +y);
      }
    }, {
      key: "bezierCurveTo",
      value: function bezierCurveTo(x1, y1, x2, y2, x, y) {
        this._append(_templateObject5 || (_templateObject5 = babelHelpers.taggedTemplateLiteral(["C", ",", ",", ",", ",", ",", ""])), +x1, +y1, +x2, +y2, this._x1 = +x, this._y1 = +y);
      }
    }, {
      key: "arcTo",
      value: function arcTo(x1, y1, x2, y2, r) {
        ...
        if (this._x1 === null) {
          this._append(_templateObject6 || (_templateObject6 = babelHelpers.taggedTemplateLiteral(["M", ",", ""])), this._x1 = x1, this._y1 = y1);
        }
        ...
        // Or, is the radius zero? Line to (x1,y1).
          ...
          this._append(_templateObject7 || (_templateObject7 = babelHelpers.taggedTemplateLiteral(["L", ",", ""])), this._x1 = x1, this._y1 = y1);
        }
        ...
        // Otherwise, draw an arc!
          ...
          if (Math.abs(t01 - 1) > epsilon$2) {
            this._append(_templateObject8 || (_templateObject8 = babelHelpers.taggedTemplateLiteral(["L", ",", ""])), x1 + t01 * x01, y1 + t01 * y01);
          }
          this._append(_templateObject9 || (_templateObject9 = babelHelpers.taggedTemplateLiteral(["A", ",", ",0,0,", ",", ",", ""])), r, r, +(y01 * x20 > x01 * y20), this._x1 = x1 + t21 * x21, this._y1 = y1 + t21 * y21);
        }
      }
    }, {
      key: "arc",
      value: function arc(x, y, r, a0, a1, ccw) {
        ...
        if (this._x1 === null) {
          this._append(_templateObject10 || (_templateObject10 = babelHelpers.taggedTemplateLiteral(["M", ",", ""])), x0, y0);
        }
        ...
        if (da > tauEpsilon) {
          this._append(_templateObject12 || (_templateObject12 = babelHelpers.taggedTemplateLiteral(["A", ",", ",0,1,", ",", ",", "A", ",", ",0,1,", ",", ",", ""])), r, r, cw, x - dx, y - dy, r, r, cw, this._x1 = x0, this._y1 = y0);
        }

        // Is this arc non-empty? Draw an arc!
        else if (da > epsilon$2) {
          this._append(_templateObject13 || (_templateObject13 = babelHelpers.taggedTemplateLiteral(["A", ",", ",0,", ",", ",", ",", ""])), r, r, +(da >= pi$2), cw, this._x1 = x + r * Math.cos(a1), this._y1 = y + r * Math.sin(a1));
        }
      }
    }, {
      key: "rect",
      value: function rect(x, y, w, h) {
        this._append(_templateObject14 || (_templateObject14 = babelHelpers.taggedTemplateLiteral(["M", ",", "h", "v", "h", "Z"])), this._x0 = this._x1 = +x, this._y0 = this._y1 = +y, w = +w, +h, -w);
      }
    }, {
      key: "toString",
  ...
  function Contours () {
    ...
    function contours(values) {
      ...
      if (!Array.isArray(tz)) {
        var e = extent(values, finite);
        tz = ticks.apply(void 0, babelHelpers.toConsumableArray(nice(e[0], e[1], tz)).concat([tz]));
    ...
    function contour(values, value) {
      ...
      if (isNaN(v)) throw new Error("invalid value: ".concat(value));
      var polygons = [],
        holes = [];
    ...
    function isorings(values, value, callback) {
      ...
      function stitch(line) {
        var start = [line[0][0] + x, line[0][1] + y],
          ...
          startIndex = index$$1(start),
          endIndex = index$$1(end),
          f,
          g;
  ...
  function _createForOfIteratorHelper$w(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray$w(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }
  ...
  function density () {
    ...
    function grid(data) {
      var values = new Float32Array(n * m),
        pow2k = Math.pow(2, -k),
        i = -1;
      var _iterator = _createForOfIteratorHelper$w(data),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var d = _step.value;
  ...
  function orient2dadapt(ax, ay, bx, by, cx, cy, detsum) {
    ...
    u[2] = _j - (u3 - bvirt) + (_i - bvirt);
    u[3] = u3;
    var Dlen = sum$1(C2len, C2, 4, u, D$1);
    return D$1[Dlen - 1];
  }
  ...
  var Delaunator = /*#__PURE__*/function () {
    babelHelpers.createClass(Delaunator, null, [{
      key: "from",
    ...
    function Delaunator(coords) {
      babelHelpers.classCallCheck(this, Delaunator);
    ...
    babelHelpers.createClass(Delaunator, [{
      key: "update",
  ...
  var Path$1 = /*#__PURE__*/function () {
    ...
    babelHelpers.createClass(Path, [{
      ...
      value: function arc(x, y, r) {
        ...
        if (this._x1 === null) this._ += "M".concat(x0, ",").concat(y0);else if (Math.abs(this._x1 - x0) > epsilon$4 || Math.abs(this._y1 - y0) > epsilon$4) this._ += "L" + x0 + "," + y0;
        if (!r) return;
  ...
  function _createForOfIteratorHelper$x(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray$x(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }
  ...
  var Voronoi = /*#__PURE__*/function () {
    function Voronoi(delaunay) {
      var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [0, 0, 960, 500],
        _ref2 = babelHelpers.slicedToArray(_ref, 4),
        xmin = _ref2[0],
        ymin = _ref2[1],
        xmax = _ref2[2],
        ymax = _ref2[3];
      babelHelpers.classCallCheck(this, Voronoi);
    ...
    babelHelpers.createClass(Voronoi, [{
      key: "update",
      value: function update() {
      ...
      value: function _init() {
        ...
        for (var i = 0, j = 0, n = triangles.length, x, y; i < n; i += 3, j += 2) {
          ...
          if (Math.abs(ab) < 1e-9) {
            ...
            // direction orthogonal to the halfedge and away from the â€œcenterâ€ of
            // the diagram <bx, by>, defined as the hullâ€™s barycenter.
            if (bx === undefined) {
              bx = by = 0;
      ...
      key: "cellPolygons",
      value: /*#__PURE__*/_regeneratorRuntime$3().mark(function cellPolygons() {
        var points, i, n, cell;
        return _regeneratorRuntime$3().wrap(function cellPolygons$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
      ...
      key: "neighbors",
      value: /*#__PURE__*/_regeneratorRuntime$3().mark(function neighbors(i) {
        var ci, _iterator2, _step2, j, cj, ai, li, aj, lj;
        return _regeneratorRuntime$3().wrap(function neighbors$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _iterator2 = _createForOfIteratorHelper$x(this.delaunay.neighbors(i));
              _context2.prev = 3;
              _iterator2.s();
            case 5:
              if ((_step2 = _iterator2.n()).done) {
        ...
        for (var j = 0; j < n; j += 2) {
          ...
          if (c0 === 0 && c1 === 0) {
            ...
            if (c0 === 0) {
              ...
              var _S = S;
              var _S2 = babelHelpers.slicedToArray(_S, 4);
              sx0 = _S2[0];
              sy0 = _S2[1];
              sx1 = _S2[2];
              sy1 = _S2[3];
              ...
              var _S3 = S;
              var _S4 = babelHelpers.slicedToArray(_S3, 4);
              sx1 = _S4[0];
              sy1 = _S4[1];
              sx0 = _S4[2];
              sy0 = _S4[3];
  ...
  var _marked$3 = /*#__PURE__*/_regeneratorRuntime$4().mark(flatIterable);
  function _createForOfIteratorHelper$y(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray$y(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e2) { throw _e2; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e3) { didErr = true; err = _e3; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }
  ...
  var Delaunay = /*#__PURE__*/function () {
    babelHelpers.createClass(Delaunay, null, [{
      key: "from",
      value: function from(points) {
    ...
    babelHelpers.createClass(Delaunay, [{
      ...
      key: "neighbors",
      value: /*#__PURE__*/_regeneratorRuntime$4().mark(function neighbors(i) {
        var inedges, hull, _hullIndex, halfedges, triangles, collinear, l, e0, e, p0, p;
        return _regeneratorRuntime$4().wrap(function neighbors$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
      ...
      value: /*#__PURE__*/_regeneratorRuntime$4().mark(function trianglePolygons() {
        var triangles, i, n;
        return _regeneratorRuntime$4().wrap(function trianglePolygons$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              triangles = this.triangles;
  ...
  function flatIterable(points, fx, fy, that) {
    ...
    return _regeneratorRuntime$4().wrap(function flatIterable$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          i = 0;
          _iterator = _createForOfIteratorHelper$y(points);
          _context3.prev = 2;
          _iterator.s();
        case 4:
  ...
  function link (links) {
    ...
    function initialize() {
      ...
      for (i = 0, count = new Array(n); i < m; ++i) {
        ...
        if (babelHelpers["typeof"](link.source) !== "object") link.source = find$1(nodeById, link.source);
        if (babelHelpers["typeof"](link.target) !== "object") link.target = find$1(nodeById, link.target);
  ...
  function polygonContains (polygon, point) {
    ...
    return (angle < -epsilon$5 || angle < epsilon$5 && sum$$1 < -epsilon2$1) ^ winding & 1;
  }
  ...
  var PathString = /*#__PURE__*/function () {
    function PathString(digits) {
      babelHelpers.classCallCheck(this, PathString);
      this._append = digits == null ? append$1 : appendRound$1(digits);
      this._radius = 4.5;
      this._ = "";
    }
    babelHelpers.createClass(PathString, [{
      key: "pointRadius",
      ...
      value: function point(x, y) {
        switch (this._point) {
          case 0:
            {
              this._append(_templateObject$1 || (_templateObject$1 = babelHelpers.taggedTemplateLiteral(["M", ",", ""])), x, y);
              this._point = 1;
              break;
            }
          case 1:
            {
              this._append(_templateObject2$1 || (_templateObject2$1 = babelHelpers.taggedTemplateLiteral(["L", ",", ""])), x, y);
              break;
            }
          default:
            {
              this._append(_templateObject3$1 || (_templateObject3$1 = babelHelpers.taggedTemplateLiteral(["M", ",", ""])), x, y);
              if (this._radius !== cacheRadius || this._append !== cacheAppend) {
                var r = this._radius;
                var s = this._;
                this._ = ""; // stash the old string so we can cache the circle path fragment
                this._append(_templateObject4$1 || (_templateObject4$1 = babelHelpers.taggedTemplateLiteral(["m0,", "a", ",", " 0 1,1 0,", "a", ",", " 0 1,1 0,", "z"])), r, r, r, -2 * r, r, r, 2 * r);
                cacheRadius = r;
  ...
  function _createForOfIteratorHelper$z(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray$z(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }
  ...
  function node_each (callback, that) {
    var index = -1;
    var _iterator = _createForOfIteratorHelper$z(this),
      _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var node = _step.value;
  ...
  var _marked$4 = /*#__PURE__*/_regeneratorRuntime$5().mark(_callee$1);
  function _callee$1() {
  ...
  Node.prototype = hierarchy.prototype = babelHelpers.defineProperty({
    constructor: Node,
    count: node_count,
    each: node_each,
  ...
  function array$4 (x) {
    return babelHelpers["typeof"](x) === "object" && "length" in x ? x // Array, TypedArray, NodeList, array-like
  ...
  function packEncloseRandom(circles, random) {
    var i = 0,
      n = (circles = shuffle$1(Array.from(circles), random)).length,
      B = [],
      p,
      e;
    while (i < n) {
  ...
  function index$3 () {
    ...
    function pack(root) {
      ...
      if (radius) {
        ...
        root.eachBefore(radiusLeaf(defaultRadius$1)).eachAfter(packChildrenRandom(constantZero, 1, random)).eachAfter(packChildrenRandom(padding, root.r / Math.min(dx, dy), random)).eachBefore(translateChild(Math.min(dx, dy) / (2 * root.r)));
      }
      return root;
    }
  ...
  function stratify () {
    ...
    function stratify(data) {
      ...
      if (path != null) {
        ...
        var S = new Set(I).add("");
        var _iterator = _createForOfIteratorHelper$B(P),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var _i = _step.value;
  ...
  // "/foo/bar" â‡¥ "/foo", "/foo" â‡¥ "/", "/" â†¦ "". (The root is special-cased
  ...
  function ordinal() {
    ...
    scale.domain = function (_) {
      ...
      domain = [], index$$1 = new InternMap();
      var _iterator = _createForOfIteratorHelper$C(_),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var value = _step.value;
  ...
  function band() {
    ...
    function rescale() {
      var n = domain().length,
        reverse$$1 = r1 < r0,
        start = reverse$$1 ? r1 : r0,
        stop = reverse$$1 ? r0 : r1;
    ...
    scale.range = function (_) {
      var _ref;
      return arguments.length ? ((_ref = babelHelpers.slicedToArray(_, 2), r0 = _ref[0], r1 = _ref[1]), r0 = +r0, r1 = +r1, rescale()) : [r0, r1];
    };
    scale.rangeRound = function (_) {
      var _ref2;
      return (_ref2 = babelHelpers.slicedToArray(_, 2), r0 = _ref2[0], r1 = _ref2[1]), r0 = +r0, r1 = +r1, round = true, rescale();
    };
  ...
  function bimap(domain, range$$1, interpolate$$1) {
    var d0 = domain[0],
      ...
      r0 = range$$1[0],
      r1 = range$$1[1];
    if (d1 < d0) d0 = normalize$1(d1, d0), r0 = interpolate$$1(r1, r0);else d0 = normalize$1(d0, d1), r0 = interpolate$$1(r0, r1);
    return function (x) {
      return r0(d0(x));
    };
  }
  ...
  function transformer$1() {
    ...
    function scale(x) {
      return x == null || isNaN(x = +x) ? unknown : (output || (output = piecewise$$1(domain.map(transform), range$$1, interpolate$$1)))(transform(clamp(x)));
    }
  ...
  function tickFormat(start, stop, count$$1, specifier) {
    var step = tickStep(start, stop, count$$1),
      precision;
  ...
  function linearish(scale) {
    ...
    scale.ticks = function (count$$1) {
      var d = domain();
      return ticks(d[0], d[d.length - 1], count$$1 == null ? 10 : count$$1);
    };
    scale.tickFormat = function (count$$1, specifier) {
      var d = domain();
      return tickFormat(d[0], d[d.length - 1], count$$1 == null ? 10 : count$$1, specifier);
    };
    scale.nice = function (count$$1) {
      if (count$$1 == null) count$$1 = 10;
      var d = domain();
      var i0 = 0;
      var i1 = d.length - 1;
      var start = d[i0];
  ...
  function loggish(transform) {
    ...
    scale.tickFormat = function (count$$1, specifier) {
      ...
      if (count$$1 === Infinity) return specifier;
      var k = Math.max(1, base * count$$1 / scale.ticks().length); // TODO fast estimate?
      return function (d) {
  ...
  function quantile$1() {
    ...
    function scale(x) {
      return x == null || isNaN(x = +x) ? unknown : range$$1[bisectRight(thresholds, x)];
    }
    ...
    scale.domain = function (_) {
      if (!arguments.length) return domain.slice();
      domain = [];
      var _iterator = _createForOfIteratorHelper$D(_),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var d = _step.value;
  ...
  function quantize$1() {
    var x0 = 0,
      ...
      unknown;
    function scale(x) {
      return x != null && x <= x ? range$$1[bisectRight(domain, x, 0, n)] : unknown;
    }
    function rescale() {
      var i = -1;
      domain = new Array(n);
    ...
    scale.domain = function (_) {
      var _ref;
      return arguments.length ? ((_ref = babelHelpers.slicedToArray(_, 2), x0 = _ref[0], x1 = _ref[1]), x0 = +x0, x1 = +x1, rescale()) : [x0, x1];
    };
    scale.range = function (_) {
    ...
    scale.copy = function () {
      return quantize$1().domain([x0, x1]).range(range$$1).unknown(unknown);
    };
  ...
  function ticker(year, month, week, day, hour, minute) {
    ...
    function ticks$$1(start, stop, count$$1) {
      var reverse$$1 = stop < start;
      if (reverse$$1) {
        var _ref = [stop, start];
        start = _ref[0];
        stop = _ref[1];
      }
      var interval = count$$1 && typeof count$$1.range === "function" ? count$$1 : tickInterval(start, stop, count$$1);
      var ticks$$1 = interval ? interval.range(start, +stop + 1) : []; // inclusive stop
      return reverse$$1 ? ticks$$1.reverse() : ticks$$1;
    }
    function tickInterval(start, stop, count$$1) {
      var target = Math.abs(stop - start) / count$$1;
      var i = bisector(function (_ref2) {
        var _ref3 = babelHelpers.slicedToArray(_ref2, 3),
          step = _ref3[2];
        return step;
      }).right(tickIntervals, target);
      if (i === tickIntervals.length) return year.every(tickStep(start / durationYear, stop / durationYear, count$$1));
      if (i === 0) return millisecond.every(Math.max(tickStep(start, stop, count$$1), 1));
      var _tickIntervals = babelHelpers.slicedToArray(tickIntervals[target / tickIntervals[i - 1][2] < tickIntervals[i][2] / target ? i - 1 : i], 2),
        t = _tickIntervals[0],
  ...
  function calendar(ticks, tickInterval, year, month, week, day, hour, minute, second$$1, format) {
    var scale = continuous(),
      invert = scale.invert,
      domain = scale.domain;
    ...
    function tickFormat(date) {
      return (second$$1(date) < date ? formatMillisecond : minute(date) < date ? formatSecond : hour(date) < date ? formatMinute : day(date) < date ? formatHour : month(date) < date ? week(date) < date ? formatDay : formatWeek : year(date) < date ? formatMonth : formatYear)(date);
    }
    scale.invert = function (y) {
    ...
    scale.copy = function () {
      return copy(scale, calendar(ticks, tickInterval, year, month, week, day, hour, minute, second$$1, format));
    };
    return scale;
  }
  function time() {
  ...
  function transformer$2() {
    ...
    scale.domain = function (_) {
      var _ref;
      return arguments.length ? ((_ref = babelHelpers.slicedToArray(_, 2), x0 = _ref[0], x1 = _ref[1]), t0 = transform(x0 = +x0), t1 = transform(x1 = +x1), k10 = t0 === t1 ? 0 : 1 / (t1 - t0), scale) : [x0, x1];
    };
    scale.clamp = function (_) {
    ...
    function range(interpolate) {
      return function (_) {
        var _ref2;
        var r0, r1;
        return arguments.length ? ((_ref2 = babelHelpers.slicedToArray(_, 2), r0 = _ref2[0], r1 = _ref2[1]), interpolator = interpolate(r0, r1), scale) : [interpolator(0), interpolator(1)];
      };
    }
  ...
  function sequentialQuantile() {
    ...
    scale.domain = function (_) {
      if (!arguments.length) return domain.slice();
      domain = [];
      var _iterator = _createForOfIteratorHelper$E(_),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var d = _step.value;
  ...
  function transformer$3() {
    ...
    scale.domain = function (_) {
      var _ref;
      return arguments.length ? ((_ref = babelHelpers.slicedToArray(_, 3), x0 = _ref[0], x1 = _ref[1], x2 = _ref[2]), t0 = transform(x0 = +x0), t1 = transform(x1 = +x1), t2 = transform(x2 = +x2), k10 = t0 === t1 ? 0 : 0.5 / (t1 - t0), k21 = t1 === t2 ? 0 : 0.5 / (t2 - t1), s = t1 < t0 ? -1 : 1, scale) : [x0, x1, x2];
    };
    scale.clamp = function (_) {
      return arguments.length ? (clamp = !!_, scale) : clamp;
    };
    ...
    function range(interpolate) {
      return function (_) {
        var _ref2;
        var r0, r1, r2;
        return arguments.length ? ((_ref2 = babelHelpers.slicedToArray(_, 3), r0 = _ref2[0], r1 = _ref2[1], r2 = _ref2[2]), interpolator = piecewise(interpolate, [r0, r1, r2]), scale) : [interpolator(0), interpolator(0.5), interpolator(1)];
      };
    }
    scale.range = range(interpolateValue);
    scale.rangeRound = range(interpolateRound);
  ...
  function line (x$$1, y$$1) {
    var defined = constant$a(true),
      ...
      output = null,
      path = withPath(line);
    x$$1 = typeof x$$1 === "function" ? x$$1 : x$$1 === undefined ? x$3 : constant$a(x$$1);
    y$$1 = typeof y$$1 === "function" ? y$$1 : y$$1 === undefined ? y$3 : constant$a(y$$1);
    function line(data) {
      var i,
  ...
  var Bump = /*#__PURE__*/function () {
    function Bump(context, x) {
      babelHelpers.classCallCheck(this, Bump);
      this._context = context;
      this._x = x;
    }
    babelHelpers.createClass(Bump, [{
      key: "areaStart",
  ...
  var BumpRadial = /*#__PURE__*/function () {
    function BumpRadial(context) {
      babelHelpers.classCallCheck(this, BumpRadial);
      this._context = context;
    }
    babelHelpers.createClass(BumpRadial, [{
      key: "lineStart",
      value: function lineStart() {
        this._point = 0;
      }
      ...
      value: function point(x, y) {
        ...
        if (this._point === 0) {
          ...
          (_this$_context = this._context).moveTo.apply(_this$_context, babelHelpers.toConsumableArray(p0));
          (_this$_context2 = this._context).bezierCurveTo.apply(_this$_context2, babelHelpers.toConsumableArray(p1).concat(babelHelpers.toConsumableArray(p2), babelHelpers.toConsumableArray(p3)));
        }
        this._x0 = x, this._y0 = y;
      }
    }]);
  ...
  function link$2(curve) {
    ...
    function link() {
      var buffer;
      var argv = slice$3.call(arguments);
  ...
  var asterisk = {
    draw: function draw(context, size) {
      var r = sqrt$2(size + min$2(size / 28, 0.75)) * 0.59436;
      var t = r / 2;
      var u = t * sqrt3;
      context.moveTo(0, r);
      context.lineTo(0, -r);
  ...
  var tan30 = sqrt$2(1 / 3);
  var tan30_2 = tan30 * 2;
  var diamond = {
    draw: function draw(context, size) {
      var y = sqrt$2(size / tan30_2);
      var x = y * tan30;
      context.moveTo(0, -y);
      context.lineTo(x, 0);
      context.lineTo(0, y);
  ...
  var plus = {
    draw: function draw(context, size) {
      var r = sqrt$2(size - min$2(size / 7, 2)) * 0.87559;
      context.moveTo(-r, 0);
      context.lineTo(r, 0);
      context.moveTo(0, r);
      context.lineTo(0, -r);
  ...
  var kr = sin$2(pi$4 / 10) / sin$2(7 * pi$4 / 10);
  var kx = sin$2(tau$5 / 10) * kr;
  var ky = -cos$2(tau$5 / 10) * kr;
  var star = {
    draw: function draw(context, size) {
      var r = sqrt$2(size * ka);
      var x = kx * r;
      var y = ky * r;
      context.moveTo(0, -r);
      context.lineTo(x, y);
  ...
  var sqrt3$2 = sqrt$2(3);
  var triangle2 = {
    draw: function draw(context, size) {
      var s = sqrt$2(size) * 0.6824;
      var t = s / 2;
      var u = s * sqrt3$2 / 2; // cos(Math.PI / 6)
      context.moveTo(0, -s);
      context.lineTo(u, t);
      context.lineTo(-u, t);
      context.closePath();
  ...
  var times = {
    draw: function draw(context, size) {
      var r = sqrt$2(size - min$2(size / 6, 1.7)) * 0.6189;
      context.moveTo(-r, -r);
      context.lineTo(r, r);
      context.moveTo(-r, r);
      context.lineTo(r, -r);
  ...
  var symbolsFill = [circle$1, cross$2, diamond, square$1, star, triangle, wye];

  // These symbols are designed to be stroked (with a width of 1.5px and round caps).
  var symbolsStroke = [circle$1, plus, times, triangle2, asterisk, square2, diamond2];
  ...
  function stack () {
    ...
    function stack(data) {
      var sz = Array.from(keys.apply(this, arguments), stackSeries),
        ...
        j = -1,
        oz;
      var _iterator = _createForOfIteratorHelper$F(data),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var d = _step.value;
  ...
  function zoom () {
    ...
    function zoom(selection$$1) {
      selection$$1.property("__zoom", defaultTransform).on("wheel.zoom", wheeled, {
        passive: false
    ...
    function schedule(transition$$1, transform, point, event) {
