(function (exports) {
	...
	var Vue = function () {
	  ...
	  function t(e) {
	    return null == e ? "" : "object" == babelHelpers.typeof(e) ? JSON.stringify(e, null, 2) : String(e);
	  }
	  ...
	  if ("undefined" != typeof setImmediate && ee(setImmediate)) Ue = function Ue() {
	    ...
	    var qe = new MessageChannel(),
	        We = qe.port2;
	    qe.port1.onmessage = Ke, Ue = function Ue() {
	      We.postMessage(1);
	    };
	  }
	  ...
	  function jt(e) {
	    ...
	    t.props && function (n, r) {
	      ...
	      var e = function e(_e2) {
	        a.push(_e2);
	        var t = Ie(_e2, r, i, n);
	        Ce(o, _e2, t), _e2 in n || Et(n, "_props", _e2);
	      };
	      ...
	      for (; i--;) {
	        var o = n[i];
	        r && p(r, o) || (36 !== (a = (o + "").charCodeAt(0)) && 95 !== a && Et(e, "_data", o));
	      }
	  ...
	  function da(e, t) {
	    ...
	    if (e.for && !e.forProcessed) return f = t, v = (u = e).for, h = u.alias, m = u.iterator1 ? "," + u.iterator1 : "", y = u.iterator2 ? "," + u.iterator2 : "", u.forProcessed = !0, ("_l") + "((" + v + "),function(" + h + m + y + "){return " + (da)(u, f) + "})";
