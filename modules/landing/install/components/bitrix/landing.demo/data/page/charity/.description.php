				...
				<div class="landing-block-card-container u-bg-overlay__inner w-100 d-flex justify-content-center g-py-40">
					<div class="container g-mr-0 g-ml-0 g-pl-0 g-pr-0">
						...
						<div class="landing-block-node-card-buttons2 js-animation slideInUp">
							<a href="#"
							   class="landing-block-node-card-link landing-block-node-card-link1 btn g-btn-type-solid g-btn-size-sm g-btn-px-l text-uppercase g-btn-primary g-color-gray-dark-v1 g-color-gray-dark-v1--hover rounded-0 g-py-10 g-py-20--md g-mr-10">
								Donate now</a>
							<a href="#"
							   class="landing-block-node-card-link landing-block-node-card-link2 btn g-btn-type-solid g-btn-size-sm g-btn-px-l text-uppercase g-btn-primary g-color-gray-dark-v1 g-color-gray-dark-v1--hover rounded-0 g-py-10 g-py-20--md g-mr-10">Learn
								more</a>
						</div>
					</div>
				</div>
			...
			<div class="landing-block-node-card js-slide g-px-15">
				...
				<article class="landing-block-node-card-bgimg clearfix g-bg-size-cover g-pos-rel g-width-100x--after" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/800x496/img4.jpg\');">
					...
					<div class="landing-block-node-card-text-bg float-right g-color-gray-light-v1 g-bg-black-opacity-0_7 g-width-50x--sm g-pa-30 g-height-100x d-flex flex-column">
						...
						<a class="btn landing-block-node-card-button js-animation fadeInLeft g-valign-middle btn-block text-uppercase g-btn-primary g-color-gray-dark-v1 rounded-0 g-py-10 g-py-20--md mt-auto g-btn-type-solid g-btn-size-sm g-btn-px-m rounded-0" href="#">
							Donate Now
						</a>
					</div>
					<!-- End Article Content -->
