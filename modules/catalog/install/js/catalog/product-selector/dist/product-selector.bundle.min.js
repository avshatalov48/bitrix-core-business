this.BX=this.BX||{};(function(e,t,i,s,o,r,n,a,l,c,d,h,g,u,I,E,m){"use strict";let p=e=>e,C,T,b,S,_,f,A,P;class N extends a.DefaultFooter{constructor(e,t){super(e,t);this.loader=null;this.errorAdminHint=t.errorAdminHint||"";this.getDialog().subscribe("onSearch",this.handleOnSearch.bind(this))}getContent(){let e="";const t=this.options.allowCreateItem===true||this.options.allowEditItem===false;if(this.isViewEditButton()&&t){e=g.Tag.render(C||(C=p`
				<div>${0}</div>
		...
		`),g.Loc.getMessage("CATALOG_SELECTOR_NEW_TAG_TITLE"))}getNameInput(){return this.cache.remember("nameInput",(()=>{const e=g.Tag.render(k||(k=R`
				<input type="text"
					...
					onchange="${0}"
				>
			`),g.Text.encode(this.inputName),g.Text.encode(this.getValue()),g.Text.encode(this.getPlaceholder()),g.Text.encode(this.getValue()),this.handleNameInputHiddenChange.bind(this));if(this.selector.getConfig("SELECTOR_INPUT_DISABLED",false)){g.Dom.addClass(e,"ui-ctl-disabled");e.setAttribute("disabled",true)}return e}))}getHiddenNameInput(){return this.cache.remember("hiddenNameInput",(()=>g.Tag.render(B||(B=R`
				<input
				 	type="hidden"
					name="${0}"
					value="${0}"
