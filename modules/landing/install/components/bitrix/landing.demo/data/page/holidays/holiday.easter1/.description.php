				...
				<article class="row flex-items-middle text-center">
					<div class="col-lg-6 align-self-center g-mb-50">
						<div class="text-uppercase text-center u-heading-v5-3 u-heading-v5-color-primary u-heading-v5-rounded-50x g-mb-20">
							...
							<h2 class="landing-block-node-card-title u-heading-v5__title g-line-height-1_2 g-font-weight-700 g-color-white g-bg-white--before g-pb-40 g-font-size-38 text-uppercase js-animation fadeInLeft">sugar rabbit and cake<br /></h2>
						</div>
	...
	<div class="container">
        ...
        <div class="container landing-block-node-subcontainer text-center g-max-width-800">
            ...
            <div class="landing-block-node-inner text-uppercase u-heading-v2-4--bottom g-brd-primary">
                ...
                <h2 class="landing-block-node-title u-heading-v2__title g-line-height-1_1 g-font-weight-700 g-mb-minus-10 g-color-black-opacity-0_8 g-font-size-38">Contact us</h2>
            </div>
