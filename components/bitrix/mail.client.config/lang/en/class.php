...
$MESS["MAIL_CLIENT_CONFIG_CRM_NEW_ENTITY_OUT_INFO_CRM_ATTENTION"] = "Attention! Any new outcoming email to a new email address will create a selected item in CRM that may be accessible to other users before access permissions are set up.";
