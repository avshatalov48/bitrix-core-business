...
if (!CSocNetFeatures::IsActiveFeature(SONET_ENTITY_USER, $arResult["VARIABLES"]["user_id"], "tasks"))
{
	echo Loc::getMessage('SU_T_TASKS_UNAVAILABLE', array(
		'#A_BEGIN#' => '<a href="'.str_replace(array("#user_id#", "#USER_ID#"), intval($arResult['VARIABLES']['user_id']), $arResult['PATH_TO_USER_FEATURES']).'">',
		'#A_END#' => '</a>'
	));
}
else
{
    $APPLICATION->IncludeComponent(
        ...
        '',
        [
            'POPUP_COMPONENT_NAME' => 'bitrix:tasks.report.view',
            ...
            'POPUP_COMPONENT_PARAMS' => [
                ...
                "PATH_TO_TASKS_REPORT" => CComponentEngine::MakePathFromTemplate(
                    ...
                    array('user_id' => intval($arResult["VARIABLES"]["user_id"]))
                ),
