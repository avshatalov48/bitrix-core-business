...
$iblockCode = "group_photogallery_community_".WIZARD_SITE_ID; 
$iblockType = "photos"; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/groups/group.php", array("PHOTO_GROUP_IBLOCK_ID" => $iblockID));
?>
