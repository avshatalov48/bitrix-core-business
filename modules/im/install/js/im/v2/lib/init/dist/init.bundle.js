...
(function (exports,im_v2_application_core,im_v2_lib_call,im_v2_lib_phone,im_v2_lib_smileManager,im_v2_lib_user,im_v2_lib_counter,im_v2_lib_logger,im_v2_lib_notifier,im_v2_lib_market,im_v2_lib_desktop) {
	'use strict';
	...
	var _initPhoneManager = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("initPhoneManager");
	class InitManager {
	  static start() {
	    ...
	    babelHelpers.classPrivateFieldLooseBase(this, _initPhoneManager)[_initPhoneManager]();
	...
	function _initPhoneManager2() {
	  ...
	  im_v2_lib_logger.Logger.warn('InitManager: phone', phoneSettings);
	  im_v2_lib_phone.PhoneManager.init(phoneSettings);
	}
	Object.defineProperty(InitManager, _initPhoneManager, {
	  value: _initPhoneManager2
	});
...
}((this.BX.Messenger.v2.Lib = this.BX.Messenger.v2.Lib || {}),BX.Messenger.v2.Application,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib));
