...
{
	$arParams['COLOR_OLD'] = [hexdec(mb_substr($arParams['COLOR_OLD'], 0, 2)), hexdec(mb_substr($arParams['COLOR_OLD'], 2, 2)), hexdec(mb_substr($arParams['COLOR_OLD'], 4, 2))];
}
else
{
	$arParams['COLOR_OLD'] = [200, 200, 200];
}
if (mb_strlen($arParams['COLOR_NEW']) == 6 && hexdec($arParams['COLOR_NEW']) > 0)
{
	$arParams['COLOR_NEW'] = [hexdec(mb_substr($arParams['COLOR_NEW'], 0, 2)), hexdec(mb_substr($arParams['COLOR_NEW'], 2, 2)), hexdec(mb_substr($arParams['COLOR_NEW'], 4, 2))];
}
else
{
	$arParams['COLOR_NEW'] = [0, 0, 0];
}
