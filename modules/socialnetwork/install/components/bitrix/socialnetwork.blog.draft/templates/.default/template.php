...
)
{
	foreach($arResult["POST"] as $ind => $CurPost)
	{
		...
		$APPLICATION->IncludeComponent(
				...
				"", 
				Array(
						"POST_VAR"				=> $arParams["POST_VAR"] ?? null,
						"USER_VAR"				=> $arParams["USER_VAR"] ?? null,
						"PAGE_VAR"				=> $arParams["PAGE_VAR"] ?? null,
						"PATH_TO_BLOG"			=> $arParams["PATH_TO_BLOG"] ?? null,
						"PATH_TO_POST" 			=> $arParams["PATH_TO_POST"] ?? null,
						"PATH_TO_BLOG_CATEGORY"	=> $arParams["PATH_TO_CATEGORY"] ?? null,
						"PATH_TO_POST_EDIT"		=> $arParams["PATH_TO_POST_EDIT"] ?? null,
