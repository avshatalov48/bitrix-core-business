...
final class AfterOpenEventEdited extends BaseEvent
{
	...
	{
		return EventType::AFTER_OPEN_EVENT_EDITED;
	}
	...
	{
		return [
			new EventSubscriber\Event\EditEventOption(),
			new EventSubscriber\Event\AfterOpenEventEdit(),
		];
	}
}