...
$MESS['BIZPROC_DEBUGGER_START_TEMPLATE_INTERCEPTION_DEAL_TITLE'] = 'Отладка на сделке из Контакт-центра';
$MESS['BIZPROC_DEBUGGER_START_TEMPLATE_INTERCEPTION_DEAL_SUBTITLE'] = 'Проследите за действиями роботов с самого начала пути клиента. Отладчик дождется новую сделку из звонка, формы, чата и других каналов, и запустит на ней отладку';
...
$MESS['BIPZROC_DEBUGGER_START_TEMPLATE_COMING_SOON'] = 'Режим находится в разработке и скоро будет доступен';
