...
return [
	'facebook' => [
		...
		'html' => '<li class="landing-block-node-list-item col g-min-width-65 list-inline-item g-mr-0"
			...
			<a class="landing-block-node-list-link d-block g-py-15 g-px-30 g-bg-facebook--hover g-bg-facebook g-color-white text-center" href="#">
	...
	'instagram' => [
		...
		'html' => '<li class="landing-block-node-list-item col g-min-width-65 list-inline-item g-mr-0"
			...
			<a class="landing-block-node-list-link d-block g-py-15 g-px-30 g-bg-instagram--hover g-bg-instagram g-color-white text-center" href="#">
	...
	'twitter' => [
		...
		'html' => '<li class="landing-block-node-list-item col g-min-width-65 list-inline-item g-mr-0"
			...
			<a class="landing-block-node-list-link d-block g-py-15 g-px-30 g-bg-twitter--hover g-bg-twitter g-color-white text-center" href="#">
	...
	'youtube' => [
		...
		'html' => '<li class="landing-block-node-list-item col g-min-width-65 list-inline-item g-mr-0"
			...
			<a class="landing-block-node-list-link d-block g-py-15 g-px-30 g-bg-youtube--hover g-bg-youtube g-color-white text-center" href="#">
	...
	'telegram' => [
		...
		'html' => '<li class="landing-block-node-list-item col g-min-width-65 list-inline-item g-mr-0"
			...
			<a class="landing-block-node-list-link d-block g-py-15 g-px-30 g-bg-telegram--hover g-bg-telegram g-color-white text-center" href="#">
	...
	'pinterest' => [
		...
		'html' => '<li class="landing-block-node-list-item col g-min-width-65 list-inline-item g-mr-0"
			...
			<a class="landing-block-node-list-link d-block g-py-15 g-px-30 g-bg-pinterest--hover g-bg-pinterest g-color-white text-center" href="#">
	...
	'skype' => [
		...
		'html' => '<li class="landing-block-node-list-item col g-min-width-65 list-inline-item g-mr-0"
			...
			<a class="landing-block-node-list-link d-block g-py-15 g-px-30 g-bg-skype--hover g-bg-skype g-color-white text-center" href="#">
	...
	'vine' => [
		...
		'html' => '<li class="landing-block-node-list-item col g-min-width-65 list-inline-item g-mr-0"
			...
			<a class="landing-block-node-list-link d-block g-py-15 g-px-30 g-bg-vine--hover g-bg-vine g-color-white text-center" href="#">
	...
	'google-plus' => [
		...
		'html' => '<li class="landing-block-node-list-item col g-min-width-65 list-inline-item g-mr-0"
			...
			<a class="landing-block-node-list-link d-block g-py-15 g-px-30 g-bg-google-plus--hover g-bg-google-plus g-color-white text-center" href="#">
	...
	'dribbble' => [
		...
		'html' => '<li class="landing-block-node-list-item col g-min-width-65 list-inline-item g-mr-0"
			...
			<a class="landing-block-node-list-link d-block g-py-15 g-px-30 g-bg-dribbble--hover g-bg-dribbble g-color-white text-center" href="#">
	...
	'linkedin' => [
		...
		'html' => '<li class="landing-block-node-list-item col g-min-width-65 list-inline-item g-mr-0"
			...
			<a class="landing-block-node-list-link d-block g-py-15 g-px-30 g-bg-linkedin--hover g-bg-linkedin g-color-white text-center" href="#">
	...
	'vk' => [
		...
		'html' => '<li class="landing-block-node-list-item col g-min-width-65 list-inline-item g-mr-0"
			data-card-preset="vk">
			<a class="landing-block-node-list-link d-block g-py-15 g-px-30 g-bg-vk--hover g-bg-vk g-color-white text-center" href="#">
	...
	'odnoklassniki' => [
		...
		'html' => '<li class="landing-block-node-list-item col g-min-width-65 list-inline-item g-mr-0"
			...
			<a class="landing-block-node-list-link d-block g-py-15 g-px-30 g-bg-odnoklassniki--hover g-bg-odnoklassniki g-color-white text-center" href="#">
