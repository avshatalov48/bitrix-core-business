...
CREATE INDEX ix_b_mail_message_uid_mailbox_id_dir_md5_msg_uid_dir_uidv_messa ON b_mail_message_uid (mailbox_id, dir_md5, msg_uid, dir_uidv, message_id, is_seen);
CREATE INDEX ix_b_mail_message_uid_id_mailbox_id_message_id_internaldate ON b_mail_message_uid (id, mailbox_id, message_id, internaldate);
