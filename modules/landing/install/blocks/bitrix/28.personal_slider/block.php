<section class="landing-block">
        ...
        <div id="team-section" class="container g-py-20">
            ...
            <div id="carouselTEAM001" class="js-carousel g-mb-50--lg"
                 ...
                 data-nav-for="#carouselTEAM001-control">
            ...
            <div id="carouselTEAM001-control" class="js-carousel text-center u-carousel-v3 g-mx-minus-15"
                 data-infinite="true"
                 data-center-mode="true"
                 data-slides-show="5"
                 data-is-thumbs="true"
                 data-lazy-load="ondemand"
                 data-nav-for="#carouselTEAM001">

                <div class="js-slide landing-block-card-bottom-slider-element g-opacity-1 g-cursor-pointer g-px-15">
                    <img class="img-fluid mb-3" src="https://cdn.bitrix24.site/bitrix/images/landing/business/400x450/img1.jpg" alt="">
                    <h3 class="h6 g-color-text">Jessica Lisbon</h3>
                </div>

                <div class="js-slide landing-block-card-bottom-slider-element g-opacity-1 g-cursor-pointer g-px-15">
                    <img class="img-fluid mb-3" src="https://cdn.bitrix24.site/bitrix/images/landing/business/400x450/img3.jpg" alt="">
                    <h3 class="h6 g-color-text">David Case</h3>
                </div>

                <div class="js-slide landing-block-card-bottom-slider-element g-opacity-1 g-cursor-pointer g-px-15">
                    <img class="img-fluid mb-3" src="https://cdn.bitrix24.site/bitrix/images/landing/business/400x450/img4.jpg" alt="">
                    <h3 class="h6 g-color-text">Maria Olsson</h3>
                </div>

                <div class="js-slide landing-block-card-bottom-slider-element g-opacity-1 g-cursor-pointer g-px-15">
                    <img class="img-fluid mb-3" src="https://cdn.bitrix24.site/bitrix/images/landing/business/400x450/img2.jpg" alt="">
                    <h3 class="h6 g-color-text">Tina Krueger</h3>
                </div>

                <div class="js-slide landing-block-card-bottom-slider-element g-opacity-1 g-cursor-pointer g-px-15">
                    <img class="img-fluid mb-3" src="https://cdn.bitrix24.site/bitrix/images/landing/business/400x450/img5.jpg" alt="">
                    <h3 class="h6 g-color-text">John Watson</h3>
                </div>

                <div class="js-slide landing-block-card-bottom-slider-element g-opacity-1 g-cursor-pointer g-px-15">
                    <img class="img-fluid mb-3" src="https://cdn.bitrix24.site/bitrix/images/landing/business/400x450/img6.jpg" alt="">
