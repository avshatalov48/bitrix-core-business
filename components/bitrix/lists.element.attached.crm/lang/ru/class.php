...
$MESS["LEAC_GRID_ACTION_ELEMENT_EDIT"] = "Редактировать";
$MESS["LEAC_GRID_ACTION_ELEMENT_SHOW_TITLE"] = "Перейти на страницу элемента";
$MESS["LEAC_GRID_ACTION_ELEMENT_UNBIND"] = "Отвязать";
$MESS["LEAC_GRID_ACTION_ELEMENT_UNBIND_TITLE"] = "Отвязать элемент от сущности crm";
