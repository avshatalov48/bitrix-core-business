this.BX=this.BX||{};this.BX.Calendar=this.BX.Calendar||{};this.BX.Calendar.Sync=this.BX.Calendar.Sync||{};(function(e,t,s,n,i,a,o,r,c,l,d,h){"use strict";let p=e=>e,u,g,_,C,E;class v{constructor(e){this.status=e.status;this.connections=e.connections;this.withStatusLabel=e.withStatusLabel;this.popupWithUpdateButton=e.popupWithUpdateButton;this.popupId=e.popupId}static createInstance(e){return new this(e)}setStatus(e){this.status=e;return this}setConnections(e){this.connections=e;return this}getContent(){let e;if(this.status==="success"){e=l.Tag.render(u||(u=p`
		...
		`),this.getMainHeader(),this.getStatusBlockContent(this.getConnections()))}getMainHeader(){return this.cache.remember("calendar-syncPanel-mainHeader",(()=>l.Tag.render(L||(L=S`
			...
			`),l.Loc.getMessage("SYNC_CALENDAR_HEADER"))))}getMobileContentWrapper(){return this.cache.remember("calendar-syncPanel-mobileContentWrapper",(()=>l.Tag.render(A||(A=S`
			<div id="calendar-sync-mobile" class="calendar-sync-mobile"></div>
		`))))}getWebContentWrapper(){return this.cache.remember("calendar-syncPanel-webContentWrapper",(()=>l.Tag.render(I||(I=S`
		...
		`),l.Loc.getMessage("CAL_SYNC_TITLE"),l.Loc.getMessage("CAL_SYNC_SUB_TITLE"))}getUnitsContentWrapper(){this.unitsContentWrapper=l.Tag.render(G||(G=H`
		...
		`),l.Loc.getMessage("CAL_SYNC_DISCONNECT_BUTTON"))}getSyncStatusClassName(){return this.provider.getStatus()==="success"?"--complete":"--error"}getContentActiveBodySectionsHeader(){return l.Tag.render(Ae||(Ae=ue`
			<div class="calendar-sync__account-desc">${0}</div>
		`),l.Loc.getMessage("CAL_SYNC_SELECTED_LIST_TITLE"))}getContentActiveBodySectionsManager(){return l.Tag.render(Ie||(Ie=ue`
		...
		`),this.getContentActiveBodyHeader(),this.getContentBody(),this.getHelpdeskBlock())}getContentActiveBodyHeader(){const e=this.connection.getSyncDate().getTime()/1e3;const t=e?d.Util.formatDateUsable(e)+" "+BX.date.format(d.Util.getTimeFormatShort(),e):"";return l.Tag.render(ke||(ke=Be`
			...
			`),this.getSyncStatusClassName(),this.getLogoIconClass(),BX.util.htmlspecialchars(this.connection.getConnectionName()),t)}getContentBody(){return l.Tag.render(Pe||(Pe=Be`
			<div class="calendar-sync__account-desc">
				${0}
			</div>
		`),l.Loc.getMessage("CAL_EXCHANGE_SELECTED_DESCRIPTION"))}getHelpdeskBlock(){return l.Tag.render(We||(We=Be`
			<div>
				<a class="calendar-sync-slider-info-link" href="javascript:void(0);" onclick="${0}">
					${0}
				</a>
		...
		`),this.getAppleInfoBlock(),this.getAppleIdTitle(),this.getAppleIdInput(),this.getAppleIdError(),this.getAppPasswordTitle(),this.getLearnMoreButton(),this.getAppPasswordInput(),this.getAppPasswordError());return this.DOM.container}getAppleInfoBlock(){if(!this.DOM.appleInfo){this.DOM.appleInfo=l.Tag.render(ht||(ht=lt`
		...
		`),this.getContentInfoBodyHeader(),this.getContentInfoWarning(),this.getContentBodyConnect())}getContentActiveBody(){return l.Tag.render(kt||(kt=Bt`
			${0}
			${0}
		`),this.getContentActiveBodyHeader(),this.getContentBodyConnect())}getContentBodyConnect(){return l.Tag.render(Pt||(Pt=Bt`
		...
		`),l.Loc.getMessage("CAL_MAC_INSTRUCTION_HEADER"),l.Loc.getMessage("CAL_MAC_INSTRUCTION_DESCRIPTION"),l.Loc.getMessage("CAL_MAC_INSTRUCTION_POINT_FIRST"),l.Loc.getMessage("CAL_MAC_INSTRUCTION_POINT_SECOND"),l.Loc.getMessage("CAL_MAC_INSTRUCTION_POINT_THIRD"),l.Loc.getMessage("CAL_MAC_INSTRUCTION_POINT_FOURTH"),l.Loc.getMessage("CAL_MAC_INSTRUCTION_POINT_FIFTH",{"#PORTAL_ADDRESS#":this.provider.getPortalAddress()}),l.Loc.getMessage("CAL_MAC_INSTRUCTION_POINT_SIXTH"),l.Loc.getMessage("CAL_MAC_INSTRUCTION_POINT_SEVENTH"),l.Loc.getMessage("CAL_MAC_INSTRUCTION_CONCLUSION"))}handleWarningButtonClick(){BX.SidePanel.Instance.getOpenSliders().forEach((e=>{if(["calendar:auxiliary-sync-slider","calendar:item-sync-connect-mac"].includes(e.getUrl())){e.close()}}));const e=d.Util.getCalendarContext();if(e){e.syncInterface.getIcloudProvider().getInterfaceUnit().getConnectionTemplate().handleConnectButton()}}}class Rt extends Ne{constructor(e,t=null){super({title:l.Loc.getMessage("CALENDAR_TITLE_MAC"),helpDeskCode:"5684075",titleInfoHeader:l.Loc.getMessage("CAL_CONNECT_MAC_CALENDAR_TITLE"),descriptionInfoHeader:l.Loc.getMessage("CAL_MAC_CONNECT_DESCRIPTION"),titleActiveHeader:l.Loc.getMessage("CAL_MAC_CALENDAR_IS_CONNECT_TITLE"),descriptionActiveHeader:l.Loc.getMessage("CAL_MAC_SELECTED_DESCRIPTION"),sliderIconClass:"calendar-sync-slider-header-icon-mac",iconPath:"/bitrix/images/calendar/sync/mac.svg",color:"#ff5752",provider:e,connection:t,popupWithUpdateButton:false})}}class Ut extends be{constructor(e,t=null){super({title:l.Loc.getMessage("CALENDAR_TITLE_YANDEX"),helpDeskCode:"10930170",titleInfoHeader:l.Loc.getMessage("CAL_CONNECT_YANDEX_CALENDAR"),descriptionInfoHeader:l.Loc.getMessage("CAL_YANDEX_CONNECT_DESCRIPTION"),titleActiveHeader:l.Loc.getMessage("CAL_YANDEX_CALENDAR_IS_CONNECT"),descriptionActiveHeader:l.Loc.getMessage("CAL_YANDEX_SELECTED_DESCRIPTION"),sliderIconClass:"calendar-sync-slider-header-icon-yandex",iconPath:"/bitrix/images/calendar/sync/yandex.svg",iconLogoClass:"--yandex",color:"#f9c500",provider:e,connection:t,popupWithUpdateButton:true})}}let xt=e=>e,Ht,$t,Xt,Gt;class Ft extends Ne{constructor(e){super(e);this.banner=new pe({type:this.provider.getType(),helpDeskCode:e.helpDeskCode});if(this.status){this.syncDate=l.Type.isDate(this.data.syncDate)?this.data.syncDate:d.Util.parseDate(this.data.syncDate)}}getContentInfoBody(){return l.Tag.render(Ht||(Ht=xt`
			${0}
			${0}
			<div class="calendar-sync-slider-section calendar-sync-slider-section-banner">
				${0}
			</div>
		`),this.getContentInfoBodyHeader(),this.getContentInfoWarning(),this.getContentBodyConnect())}getContentActiveBody(){return l.Tag.render($t||($t=xt`
			${0}
			<div class="calendar-sync-slider-section calendar-sync-slider-section-banner">
				${0}
			</div>
		`),this.getContentActiveBodyHeader(),this.getContentBodyConnect())}getContentActiveBodyHeader(){const e=this.connection.getSyncDate().getTime()/1e3;const t=e?d.Util.formatDateUsable(e)+" "+BX.date.format(d.Util.getTimeFormatShort(),e):"";return l.Tag.render(Xt||(Xt=xt`
			<div class="calendar-sync-slider-section">
				<div class="calendar-sync-slider-header-icon ${0}"></div>
				<div class="calendar-sync-slider-header">
			...
			</div>`),this.sliderIconClass,this.titleActiveHeader,l.Loc.getMessage("CAL_SYNC_LAST_SYNC_DATE"),t,l.Loc.getMessage("CAL_SYNC_DISABLE"),this.showHelp.bind(this),l.Loc.getMessage("CAL_TEXT_ABOUT_WORK_SYNC"))}getContentBodyConnect(){this.banner.initQrCode().then(this.banner.drawQRCode.bind(this.banner));return this.banner.getContainer()}getActiveConnectionContent(){return l.Tag.render(Gt||(Gt=xt`
			<div class="calendar-sync-wrap calendar-sync-wrap-detail">
				<div class="calendar-sync-header">
					<span class="calendar-sync-header-text">${0}</span>
				</div>
		...
		`),this.getHeaderTitle(),this.getContentActiveBody())}}class Yt extends Ft{constructor(e,t=null){super({title:l.Loc.getMessage("CALENDAR_TITLE_ANDROID"),helpDeskCode:"5686179",titleInfoHeader:l.Loc.getMessage("CAL_CONNECT_ANDROID_CALENDAR_TITLE"),descriptionInfoHeader:l.Loc.getMessage("CAL_ANDROID_CONNECT_DESCRIPTION"),titleActiveHeader:l.Loc.getMessage("CAL_SYNC_CONNECTED_ANDROID_TITLE"),descriptionActiveHeader:l.Loc.getMessage("CAL_ANDROID_SELECTED_DESCRIPTION"),sliderIconClass:"calendar-sync-slider-header-icon-android",iconPath:"/bitrix/images/calendar/sync/android.svg",color:"#9ece03",provider:e,connection:t,popupWithUpdateButton:false});this.warningText=l.Loc.getMessage("CAL_SYNC_WARNING_ANDROID");this.warningButtonText=l.Loc.getMessage("CALENDAR_CONNECT_GOOGLE")}handleWarningButtonClick(){BX.SidePanel.Instance.getOpenSliders().forEach((e=>{if(["calendar:auxiliary-sync-slider","calendar:item-sync-connect-android"].includes(e.getUrl())){e.close()}}));const e=d.Util.getCalendarContext();if(e){e.syncInterface.getGoogleProvider().getInterfaceUnit().getConnectionTemplate().handleConnectButton()}}}class zt extends Ft{constructor(e,t=null){super({title:l.Loc.getMessage("CALENDAR_TITLE_IPHONE"),helpDeskCode:"5686207",titleInfoHeader:l.Loc.getMessage("CAL_CONNECT_IPHONE_CALENDAR_TITLE"),descriptionInfoHeader:l.Loc.getMessage("CAL_IPHONE_CONNECT_DESCRIPTION"),titleActiveHeader:l.Loc.getMessage("CAL_SYNC_CONNECTED_IPHONE_TITLE"),descriptionActiveHeader:l.Loc.getMessage("CAL_IPHONE_SELECTED_DESCRIPTION"),sliderIconClass:"calendar-sync-slider-header-icon-iphone",iconPath:"/bitrix/images/calendar/sync/iphone.svg",color:"#2fc6f6",provider:e,connection:t,popupWithUpdateButton:false});this.warningText=l.Loc.getMessage("CAL_SYNC_WARNING_IPHONE_AND_MAC");this.warningButtonText=l.Loc.getMessage("CALENDAR_CONNECT_ICLOUD")}handleWarningButtonClick(){BX.SidePanel.Instance.getOpenSliders().forEach((e=>{if(["calendar:auxiliary-sync-slider","calendar:item-sync-connect-iphone"].includes(e.getUrl())){e.close()}}));const e=d.Util.getCalendarContext();if(e){e.syncInterface.getIcloudProvider().getInterfaceUnit().getConnectionTemplate().handleConnectButton()}}}let jt=e=>e,qt,Kt;var Vt=babelHelpers.classPrivateFieldLooseKey("showSuccessCopyNotification");var Qt=babelHelpers.classPrivateFieldLooseKey("showFailedCopyNotification");var Zt=babelHelpers.classPrivateFieldLooseKey("showResultNotification");class Jt{constructor(e){Object.defineProperty(this,Zt,{value:ss});Object.defineProperty(this,Qt,{value:ts});Object.defineProperty(this,Vt,{value:es});this.LINK_LENGTH=112;this.link=this.getIcalLink(e)}static createInstance(e){return new this(e)}show(){this.createPopup().show();this.startSync()}startSync(){BX.ajax.get(this.link+"&check=Y","",(e=>{setTimeout((()=>{if(!e||e.length<=0||e.toUpperCase().indexOf("BEGIN:VCALENDAR")===-1){this.showPopupWithSyncDataError()}}),300)}))}getContent(){return l.Tag.render(qt||(qt=jt`
			<div class="calendar-ical-popup-wrapper">
				<h3>${0}</h3>
				<div class="calendar-ical-popup-label-text"><span>${0}</span></div>
				${0}
			</div>
		`),l.Loc.getMessage("EC_JS_EXPORT_TILE"),l.Loc.getMessage("EC_EXP_TEXT"),this.getLinkBlock())}createPopup(){return this.popup=new h.Popup({width:400,zIndexOptions:4e3,autoHide:false,closeByEsc:true,draggable:true,closeIcon:{right:"12px",top:"10px"},className:"bxc-popup-window",content:this.getContent(),buttons:[new BX.UI.Button({text:l.Loc.getMessage("EC_JS_ICAL_COPY_ICAL_SYNC_LINK"),color:BX.UI.Button.Color.PRIMARY,onclick:()=>{this.copyLink(event)}}),new BX.UI.Button({text:l.Loc.getMessage("EC_SEC_SLIDER_CLOSE"),color:BX.UI.Button.Color.LINK,onclick:()=>{this.popup.close()}})]})}getIcalLink(e){return e.calendarPath+(e.calendarPath.indexOf("?")>=0?"&":"?")+"action=export"+e.sectionLink}getLinkBlock(){return l.Tag.render(Kt||(Kt=jt`
				<div class="calendar-ical-popup-link-block">
					<a class="ui-link ui-link-primary " target="_blank" href="${0}">
						${0}
					</a>
				</div>
			`),BX.util.htmlspecialchars(this.link),BX.util.htmlspecialchars(this.getShortenLink(this.link)))}static checkPathes(e){return!!e.sectionLink||!!e.calendarPath}static showPopupWithPathesError(){BX.UI.Dialogs.MessageBox.alert(l.Loc.getMessage("EC_JS_ICAL_ERROR_WITH_PATHES"))}showPopupWithSyncDataError(){BX.UI.Dialogs.MessageBox.alert(l.Loc.getMessage("EC_EDEV_EXP_WARN"))}copyLink(e){window.BX.clipboard.copy(this.link)?babelHelpers.classPrivateFieldLooseBase(this,Vt)[Vt]():babelHelpers.classPrivateFieldLooseBase(this,Qt)[Qt]();e.preventDefault();e.stopPropagation()}getShortenLink(e){return e.length<this.LINK_LENGTH?e:e.substr(0,105)+"..."+e.slice(-7)}}function es(){babelHelpers.classPrivateFieldLooseBase(this,Zt)[Zt](l.Loc.getMessage("EC_JS_ICAL_COPY_ICAL_SYNC_LINK_SUCCESS"))}function ts(){babelHelpers.classPrivateFieldLooseBase(this,Zt)[Zt](l.Loc.getMessage("EC_JS_ICAL_COPY_ICAL_SYNC_LINK_FAILED"))}function ss(e){d.Util.showNotification(e)}class ns{constructor(e={}){this.options=e}static createInstance(e){return new this(e)}loadExtension(){return new Promise((e=>{l.Runtime.loadExtension("ui.tour").then((t=>{if(t&&t["Guide"]&&t["Manager"]){e()}else{console.error(`Extension "ui.tour" not found`)}}))}))}show(){this.loadExtension().then((()=>{this.guide=new BX.UI.Tour.Guide({steps:[{target:this.getTarget(),title:l.Loc.getMessage("CAL_AFTER_SYNC_AHA_TITLE"),text:l.Loc.getMessage("CAL_AFTER_SYNC_AHA_TEXT")}],onEvents:true});this.guide.start()}))}getTarget(){let e;const t=this.options.view;const s=t.getContainer();if(t.getName()==="month"){e=s.querySelectorAll(".calendar-grid-today")[0]}else if(t.getName()==="day"||t.getName()==="week"){const t=d.Util.getDayCode(new Date);e=s.querySelector('div[data-bx-calendar-timeline-day="'+t+'"] .calendar-grid-cell-inner')}else{e=document.querySelector('span[data-role="addButton"]')}return e}}e.SyncPanel=q;e.SyncPanelUnit=x;e.AuxiliarySyncPanel=D;e.GridUnit=ee;e.ConnectionControls=ce;e.MobileSyncBanner=pe;e.YandexTemplate=Ut;e.CaldavTemplate=Me;e.MacTemplate=Wt;e.ExchangeTemplate=Re;e.GoogleTemplate=ct;e.IcloudTemplate=Dt;e.OutlookTemplate=Rt;e.IphoneTemplate=zt;e.AndroidTemplate=Yt;e.IcalSyncPopup=Jt;e.AfterSyncTour=ns;e.GoogleSyncWizard=rt;e.Office365template=Mt;e.IcloudAuthDialog=yt})(this.BX.Calendar.Sync.Interface=this.BX.Calendar.Sync.Interface||{},BX,BX,BX.Calendar.Sync.Manager,BX.Calendar,BX,BX,BX.Event,BX.UI.Dialogs,BX,BX.Calendar,BX.Main);
