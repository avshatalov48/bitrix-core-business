								...
								<div class="col">
									<div class="row">
										<div class="col-sm mb-3">
											...
											<a class="sale-order-detail-about-order-inner-container-name-read-less"><?= Loc::getMessage('SPOD_LIST_LESS') ?></a>
										...
										<?
											if ($arParams['GUEST_MODE'] !== 'Y')
											{
												...
												<div class="col-sm-auto mb-3 text-center">
													...
													{
														?>
														<a href="<?=$arResult["URL_TO_CANCEL"]?>" class=""><?= Loc::getMessage('SPOD_ORDER_CANCEL') ?></a>
														<?
													}
													?>
												</div>
														...
														<div class="row align-items-center sale-order-detail-payment-options-methods-information-block">
															...
															if ($payment['PAY_SYSTEM']["IS_CASH"] !== "Y")
															{
																...
																<div class="col-md-2 col-sm-12 sale-order-detail-payment-options-methods-button-container">
																	...
																	{
																		?>
																		<a class="btn btn-primary btn-block" target="_blank" href="<?=htmlspecialcharsbx($payment['PAY_SYSTEM']['PSA_ACTION_FILE'])?>"><?= Loc::getMessage('SPOD_ORDER_PAY') ?></a>
																		<?
																	}
																	else
																	{
																		...
																		{
																			?>
																			<button class="btn btn-primary btn-block disabled"><?= Loc::getMessage('SPOD_ORDER_PAY') ?></button>
																			<?
																		}
																		else
																		{
																			?>
																			<button class="btn btn-primary btn-block active-button"><?= Loc::getMessage('SPOD_ORDER_PAY') ?></button>
																			<?
																		}
																	}
																	?>
