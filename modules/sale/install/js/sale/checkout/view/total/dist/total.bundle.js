...
(function (exports,sale_checkout_const,main_core_events,ui_vue,currency_currencyCore) {
    ...
    ui_vue.Vue.component('sale-checkout-view-total-basket', {
      props: ['total'],
      computed: {
        localize: function localize() {
          return Object.freeze(ui_vue.Vue.getFilteredPhrases('CHECKOUT_VIEW_TOTAL_'));
        },
    ...
    ui_vue.Vue.component('sale-checkout-view-total-discount', {
      props: ['total'],
      computed: {
        localize: function localize() {
          return Object.freeze(ui_vue.Vue.getFilteredPhrases('CHECKOUT_VIEW_TOTAL_'));
    ...
    ui_vue.Vue.component('sale-checkout-view-total-summary', {
      props: ['total'],
      computed: {
        localize: function localize() {
          return Object.freeze(ui_vue.Vue.getFilteredPhrases('CHECKOUT_VIEW_TOTAL_'));
    ...
    ui_vue.Vue.component('sale-checkout-view-total', {
      props: ['total', 'showBackdrop'],
      computed: {
        localize: function localize() {
          return Object.freeze(ui_vue.Vue.getFilteredPhrases('CHECKOUT_VIEW_TOTAL_CLOSE'));
        },
