<section class="landing-block g-pt-30 g-pb-30">
	<div class="container g-max-width-800">
		<div class="row g-flex-centered">
			<div class="landing-block-node-button-container text-center col-md-4 js-animation slideInLeft">
			...
			<div class="landing-block-node-text text-center col-md-8 js-animation slideInRight">
				<p>
