...
$MESS["SECURITY_SITE_CHECKER_HOSTS_NOT_RESTRICTED"] = "Host/domain restriction disabled";
$MESS["SECURITY_SITE_CHECKER_HOSTS_NOT_RESTRICTED_DETAIL"] = "Use domain and host restriction to prevent HTTP/Host attacks.";
$MESS["SECURITY_SITE_CHECKER_HOSTS_NOT_RESTRICTED_RECOMMENDATION"] = "Proceed to the <a href=\"/bitrix/admin/security_hosts.php?find_rule_type=M\" target=\"_blank\">restriction settings page</a> to enable restriction.";
...
$MESS["SECURITY_SITE_CHECKER_PASSWORD_RESTORING_CAPTCHA_OFF"] = "Password recovery page does not use CAPTCHA";
$MESS["SECURITY_SITE_CHECKER_PASSWORD_RESTORING_CAPTCHA_OFF_DETAIL"] = "Attempt of a brute force attack is possible.";
$MESS["SECURITY_SITE_CHECKER_PASSWORD_RESTORING_CAPTCHA_OFF_RECOMMENDATION"] = "Enable CAPTCHA in the <a href=\"/bitrix/admin/settings.php?mid=main\" target=\"_blank\">Kernel module settings</a>.";
...
$MESS["SECURITY_SITE_CHECKER_REGISTRATION_CAPTCHA_OFF"] = "User registration does not use CAPTCHA";
$MESS["SECURITY_SITE_CHECKER_REGISTRATION_CAPTCHA_OFF_DETAIL"] = "Your site is not protected against unwanted or automated registrations.";
$MESS["SECURITY_SITE_CHECKER_REGISTRATION_CAPTCHA_OFF_RECOMMENDATION"] = "Enable CAPTCHA in the <a href=\"/bitrix/admin/settings.php?mid=main\" target=\"_blank\">Kernel module settings</a>.";
