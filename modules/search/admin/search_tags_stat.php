...
$arHeaders = [
	['id' => 'TAGS', 'content' => GetMessage('SEARCH_TAGSTAT_TAGS'), 'sort' => 'TAGS', 'default' => true],
	['id' => 'COUNT', 'content' => GetMessage('SEARCH_TAGSTAT_COUNT'), 'sort' => 'COUNT', 'default' => true, 'align' => 'right'],
];
...
?>
<tr>
	<td nowrap><b><?php echo GetMessage('SEARCH_TAGSTAT_TAGS')?>:</b></td>
	<td><input type="text" name="find_tags" size="47" value="<?php echo htmlspecialcharsbx($find_tags)?>"></td>
</tr>
<tr>
	<td><?php echo GetMessage('SEARCH_TAGSTAT_ID')?>:</td>
	<td><input type="text" name="find_id" size="47" value="<?php echo htmlspecialcharsbx($find_id)?>"></td>
</tr>
<tr>
	<td width="0%" nowrap><?php echo GetMessage('SEARCH_TAGSTAT_DATE')?>:</td>
	<td width="0%" nowrap><?php echo CalendarPeriod('find_date1', $find_date1, 'find_date2', $find_date2, 'form1','Y')?></td>
</tr>
<tr>
	<td><?php echo GetMessage('SEARCH_TAGSTAT_SITE_ID')?>:</td>
	<td><?php echo SelectBoxFromArray('find_site_id', $arSiteDropdown, $find_site_id, GetMessage('SEARCH_TAGSTAT_SITE'));?></td>
</tr>

<tr>
	<td nowrap><?php echo GetMessage('SEARCH_TAGSTAT_URL_TO')?></td>
	<td><?php
		echo SelectBoxFromArray('find_url_to_404', ['reference' => [GetMessage('MAIN_YES'), GetMessage('MAIN_NO')], 'reference_id' => ['Y','N']], htmlspecialcharsbx($find_url_to_404), GetMessage('SEARCH_TAGSTAT_404'));
	?>&nbsp;<input type="text" name="find_url_to" size="33" value="<?php echo htmlspecialcharsbx($find_url_to)?>"></td>
</tr>
<tr>
	<td nowrap><?php echo GetMessage('SEARCH_TAGSTAT_STAT_SESS_ID')?></td>
