...
<section class="landing-block g-pt-15 g-pb-15 g-pl-15 g-pr-15 g-theme-bitrix-bg-dark-v2">
	<div class="container">
		<form class="landing-block-node-form input-group g-font-open-sans">
			...
			<div class="landing-block-node-button-container input-group-append g-z-index-4 g-bg-gray-light-v4 g-bg-gray-light-v5--hover g-color-black g-color-black--hover g-font-montserrat g-font-size-15">
				<button class="g-brd-1 g-brd-style-solid g-brd-transparent g-bg-transparent text-uppercase g-pl-20 g-pr-20 g-letter-spacing-2"
						type="submit">
					<div class="d-none d-md-block"><?=Loc::getMessage("LANDING_BLOCK_59_3_SEARCH")?></div>
