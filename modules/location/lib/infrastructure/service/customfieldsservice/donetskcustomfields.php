...
class DonetskCustomFields extends CustomFields
{
	/**
	 * @inheritDoc
	 */
	protected function getInfo(): array
	{
		if ($this->currentRegion === 'ru')
		{
			...
			$state = Loc::getMessage('LOCATION_ISTRUCTURE_CUSTOM_FIELDS_REGION_DONETSK_FOR_RUSSIA');
		}
		else
		{
			$country = Loc::getMessage('LOCATION_ISTRUCTURE_CUSTOM_FIELDS_UKRAINE');
			$state = Loc::getMessage('LOCATION_ISTRUCTURE_CUSTOM_FIELDS_REGION_DONETSK_FOR_UKRAINE');
		}
